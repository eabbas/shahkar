...
<body>
    ...
    <!-- ads -->
    <div class="w-full h-10 bg-[#FD9636] flex flex-row justify-around">
        <span class="text-white py-2 px-4 font-medium flex justify-start items-center">
    ...
    <header class="2xl:container 2xl:px-4 mx-auto w-full border-b border-[#D5DFE4] py-3">
        ...
        <div class="2xl:w-full w-[98%] mx-auto lg:flex xl:flex-row hidden lg:flex-col items-center gap-5">
            <div class="xl:w-8/12 w-full flex flex-row justify-center gap-5 xl:justify-start items-center">
                ...
                <div class="2xl:w-5/12 xl:w-6/12 ">
                    <form action="" method=""
                        class="border border-[#D5DFE4] rounded-full min-w-[395px] w-[395px] p-1 text-sm flex flex-row">
                        <select name="category" class="min-w-[150px] text-[#425A8B]" id="">
                            <option value="all">
                                همه دسته ها
                            </option>
                            <option value="1">
                        ...
                        <input type="text"
                            class="w-full border-r border-[#D5DFE4] pr-1.5 mr-1.5 text-[#425A8B] text-sm py-1 outline-none rounded-l-full"
                ...
                <div class="size-9 p-2 hidden 2xl:hidden lg:flex flex-col gap-1 bg-[#F0F3F8] rounded-sm cursor-pointer"
                    id="chocIcon">
                    <div class="flex flex-row justify-between items-center">
                        <span class="size-1 bg-[#425A8B] rounded-full"></span>
                        <span class="size-1 bg-[#425A8B] rounded-full"></span>
                        <span class="size-1 bg-[#425A8B] rounded-full"></span>
                    </div>
                    <div class="flex flex-row justify-between items-center">
                ...
                <!-- 2xl menu -->
                <ul class="w-6/12 hidden 2xl:flex flex-row justify-start items-center gap-4 text-[#425A8B]">
                    <li>
                    ...
                    <li class="menuItemParent">
                        ...
                        <div
                            class="absolute w-full py-5 max-h-0 border border-[#D5DFE4] bg-white opacity-0 mt-8 right-0 invisible z-[9999] transition-all duration-500">
                            <div class="w-11/12 mx-auto flex flex-row items-start gap-10">
                                <div class="w-1/5 flex flex-col justify-start gap-4">
                                    <button
                                        class="block rounded-[10px] text-[#425A8B] py-4 px-9 bg-[#f0f3f8] transitin-all duration-300 hover:bg-[#425A8B] hover:text-white cursor-pointer activeSubMenuCat subMenuCat">عنوان
                                        تستی</button>
                                    <button
                                        class="block rounded-[10px] text-[#425A8B] py-4 px-9 bg-[#f0f3f8] transitin-all duration-300 hover:bg-[#425A8B] hover:text-white cursor-pointer subMenuCat">عنوان
                                        تستی</button>
                                    <button
                                        class="block rounded-[10px] text-[#425A8B] py-4 px-9 bg-[#f0f3f8] transitin-all duration-300 hover:bg-[#425A8B] hover:text-white cursor-pointer subMenuCat">عنوان
                                        تستی</button>
                                ...
                                <div class="w-4/5">
                                    ...
                                    <div class="grid grid-cols-4 gap-4 max-h-[575px] overflow-y-auto">
                                        <div class="p-4 border border-[#d5def4] rounded-[10px]">
                                            ...
                                            <span class="block text-center text-[14px] text-[#8C9EC5]">تست آیتم</span>
                                            <span class="block text-center text-[12px] text-[#8C9EC5]">10 آیتم</span>
                                        </div>
                                        <div class="p-4 border border-[#d5def4] rounded-[10px]">
                                            <a href="#" class="block mb-1">
                                                <img src="https://elango.steelthemes.com/ecom/el2/wp-content/uploads/2025/07/category-1.png"
                    ...
                    <li class="relative menuItemParent">
                        <a href="#"
                            class="text-[#425A8B] font-semibold text-sm flex flex-row items-center gap-1 transition-all duration-300 py-4 menuLink">
                            <span>
                                فروشگاه
                            </span>
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-3" viewBox="0 0 448 512">
                        ...
                        <ul
                            class="absolute min-w-[250px] py-4 px-6 border border-[#D5DFE4] bg-white top-full opacity-0 mt-8 right-0 invisible z-[9999] transition-all duration-500 menuItemChild">
                            <li>
                                <a href="#"
                                    class="block py-2.5 text-sm font-semibold transitin-all duration-300 hover:text-[#FD9636]">عنوان
                                    تستی</a>
                            </li>
                            <li>
                                <a href="#"
                    ...
                    <li>
                        <a href="#"
                            class="text-[#425A8B] font-semibold text-sm gap-1 transition-all duration-300 py-4 menuLink">
            ...
            <div class="xl:w-4/12 w-full">
                <div class="flex flex-row md:justify-center xl:justify-end items-center gap-5">
                    <a href="#" class="flex items-center gap-5">
                        ...
                        <div>
                            <span class="block text-[#425A8B] leading-[22px] font-medium text-sm">اکانت من</span>
                            <span class="block text-[#425A8B] leading-[22px] text-xs">با احترام وارد شوید</span>
                        </div>
                    </a>
                    <a href="#" class="inline-block w-8 h-6 relative">
                        ...
                        <span
                            class="flex justify-center items-center -top-2.5 -left-2.5 absolute size-5 bg-[#FD9636] rounded-full text-white text-sm">0</span>
                    </a>
                    <a href="#" class="inline-block w-8 h-6 relative">
                    ...
                    <div
                        class="flex flex-row items-center gap-5 p-2 border border-[#D5DFE4] rounded-full cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-5" viewBox="0 0 384 512">
                            <path fill="#425A8B"
                                d="M336 192c0-79.5-64.5-144-144-144S48 112.5 48 192c0 12.4 4.5 31.6 15.3 57.2c10.5 24.8 25.4 52.2 42.5 79.9c28.5 46.2 61.5 90.8 86.2 122.6c24.8-31.8 57.8-76.4 86.2-122.6c17.1-27.7 32-55.1 42.5-79.9C331.5 223.6 336 204.4 336 192zm48 0c0 87.4-117 243-168.3 307.2c-12.3 15.3-35.1 15.3-47.4 0C117 435 0 279.4 0 192C0 86 86 0 192 0S384 86 384 192zm-160 0a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zm-112 0a80 80 0 1 1 160 0 80 80 0 1 1 -160 0z" />
                        </svg>
                        <span class="text-sm text-[#425A8B]">
                            بناب
                        </span>
                    </div>
                </div>
        ...
        <div class="w-11/12 mx-auto lg:hidden flex flex-row justify-between items-center py-4">
            ...
            <div class="flex flex-row justify-end items-center gap-5">
                <a href="#" class="inline-block w-8 h-6 relative">
                    ...
                    <span
                        class="flex justify-center items-center -top-2 -left-2 absolute size-4 bg-[#FD9636] rounded-full text-white text-sm">0</span>
                </a>
                <a href="#" class="inline-block w-8 h-6 relative">
                ...
                <div class="size-7 p-1 flex flex-col gap-1 bg-[#F0F3F8] rounded-sm cursor-pointer" id="chocIconMobile">
                    <div class="flex flex-row justify-between items-center">
                        <span class="size-1 bg-[#425A8B] rounded-full"></span>
                        <span class="size-1 bg-[#425A8B] rounded-full"></span>
                        <span class="size-1 bg-[#425A8B] rounded-full"></span>
        ...
        <div class="fixed z-[9999] w-full h-svh bg-black/70 top-0 -right-full transition-all duration-500"
            ...
            <div class="relative w-11/12 mx-auto mt-5 bg-white rounded-md h-[565px] p-7 opacity-0  transition-all duration-300 delay-600"
                id="boxC">
                <button
                    class="absolute size-10 rounded-full bg-[#F0F3F8] font-bold -top-3 -right-3 z-20 flex justify-center items-center cursor-pointer"
                ...
                <ul class="w-full h-[444px] overflow-y-auto">
                    <li class="my-1">
                        <a href="#"
                            class="inline-block w-full text-[#425A8B] font-semibold py-3 transition-all duration-300 px-3 rounded-lg hover:bg-[#F0F3F8]">
                            خانه
                        </a>
                    </li>
                    <li class="my-1">
                        <div
                            class="flex flex-row justify-between items-center gap-1 transition-all duration-300 px-3 rounded-lg hover:bg-[#F0F3F8]">
                            <a href="#" class="inline-block w-11/12 text-[#425A8B] font-semibold py-3 ">
                                دسته بندی
                            </a>
                        ...
                        <div class="w-full max-h-0 overflow-hidden transition-all duration-500 mt-2 subItem">
                            ...
                            <div class="w-full flex flex-col items-start gap-10">
                                ...
                                <div class="w-full">
                                    <!-- contents -->
                                    <div class="grid sm:grid-cols-2 grid-cols-1 gap-4 max-h-[575px] overflow-y-auto">
                                        <div class="p-4 border border-[#d5def4] rounded-[10px]">
                                            <a href="#" class="block mb-1">
                                                <img src="https://elango.steelthemes.com/ecom/el2/wp-content/uploads/2025/07/category-1.png"
                                                    class="w-[85px] h-20 mx-auto" alt="product">
                                            ...
                                            <span class="block text-center text-[14px] text-[#8C9EC5]">تست
                                                آیتم</span>
                                            <span class="block text-center text-[12px] text-[#8C9EC5]">10
                                                آیتم</span>
                                        </div>
                                        <div class="p-4 border border-[#d5def4] rounded-[10px]">
                                            <a href="#" class="block mb-1">
    ...
    <main class="2xl:container 2xl:px-4 w-11/12 lg:w-[98%] mx-auto mt-5">
        <!-- sub header -->
        <section class="flex flex-col lg:flex-row gap-5 text-[#425A8B]">
            <div
                class="lg:w-2/3 w-full rounded-md bg-[#F0F3F8] bg-center bg-[url('https://elango.steelthemes.com/ecom/el2/wp-content/uploads/2025/07/pattern-4.png')] bg-cover bg-no-repeat p-8 lg:py-12 lg:px-20 relative overflow-hidden h-[440px] lg:h-auto max-h-[501px]">
                <div class="w-2/3">
                    ...
                    <div class="flex flex-row justify-start items-center gap-5">
                        <a href="#"
                            class="bg-[#FD9636] text-sm lg:text-base rounded-[10px] py-2 px-5 text-white font-semibold transition-all duration-500 ease-in-out hover:bg-[#425A8B]">خرید</a>
                        <a href="#"
            ...
            <div class="lg:w-1/3 w-full flex flex-col sm:flex-row lg:flex-col gap-5">
                <div
                    class="sm:w-1/2 lg:w-full bg-[#F0F3F8] bg-[url('https://elango.steelthemes.com/ecom/el2/wp-content/uploads/2025/07/banner-1.png')] bg-cover rotate-y-180 bg-bottom-right bg-no-repeat min-h-[225px] rounded-[10px] p-[30px]">
                    <div class="rotate-y-180 flex flex-col gap-5">
                        ...
                        <div class="flex">
                            <a href="#"
                                class="bg-[#425A8B] rounded-[10px] text-sm lg:text-base py-2 px-5 text-white font-semibold transition-all duration-500 ease-in-out hover:bg-[#FD9636] flex items-center gap-2 buttonLink">
                                <span>خرید</span>
                ...
                <div
                    class="sm:w-1/2 lg:w-full bg-[#F0F3F8] bg-[url('https://elango.steelthemes.com/ecom/el2/wp-content/uploads/2025/07/banner-2.png')] bg-cover rotate-y-180 bg-bottom-right bg-no-repeat min-h-[256px] rounded-[10px] p-[30px]">
                    <div class="rotate-y-180 flex flex-col gap-5">
                        ...
                        <div class="flex">
                            <a href="#"
                                class="bg-[#FD9636] rounded-[10px] text-sm lg:text-base py-2 px-5 text-white font-semibold transition-all duration-500 ease-in-out hover:bg-[#425A8B] flex items-center gap-2 buttonLink">
                                <span>خرید</span>
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-2.5 h-5" viewBox="0 0 320 512">
                                    <path fill="white"
                                        d="M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" />
        ...
        <!-- category -->
        <section class="text-[#425A8B] pt-3">
            <!-- title section -->
            <div class="flex flex-row justify-between items-center py-10">
                <h2 class="font-bold text-[24px] leading-8">دسته های پرطرفدار</h2>
                <div class="flex flex-row justify-end items-center gap-5">
                    <span class="size-[35px] rounded-[12px] border border-[#d5def4] flex justify-center items-center">
        ...
        <section class="text-[#425A8B] pt-3">
            ...
            <div class="flex flex-col lg:flex-row justify-between gap-8 lg:gap-0 lg:items-center py-5 lg:py-10">
                <h2 class="font-bold lg:text-[24px] leading-8">دسته های پرطرفدار</h2>
                <div
                    class="flex flex-row flex-wrap lg:justify-end items-center text-xs lg:text-base gap-5 font-semibold">
                    <a href="#" class="text-[#425A8B]">
                        همه دسته ها
                    </a>
                    <a href="#" class="text-[#8C9EC5]">
                        تست 1
                    </a>
                    <a href="#" class="text-[#8C9EC5]">
                        تست 2
            ...
            <div class="grid 2xl:grid-cols-6 grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2.5 lg:gap-5">
                <!-- 12 -->
                <div class="p-2 md:p-3 lg:p-4 xl:p-5 border border-[#d5def4] rounded-[10px] relative productItem">
                    <div
                        class="absolute top-[5px] lg:top-2.5 left-[5px] lg:left-2.5 hidden md:flex flex-col gap-2 z-[555] overflow-hidden">

                        <button
                            class="size-8 border border-[#D5DFE4] buttonProduct bg-white rounded-[4px] flex justify-center items-center -translate-x-4 opacity-0 cursor-pointer transition-all duration-500">
                        ...
                        <button
                            class="size-8 border border-[#D5DFE4] buttonProduct bg-white rounded-[4px] flex justify-center items-center -translate-x-4 opacity-0 cursor-pointer transition-all duration-500 delay-[50ms]">
                        ...
                        <button
                            class="size-8 border border-[#D5DFE4] buttonProduct bg-white rounded-[4px] flex justify-center items-center -translate-x-4 opacity-0 cursor-pointer transition-all duration-500 delay-[100ms]">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-4" viewBox="0 0 448 512">
                                <path fill="#425A8B"
                        ...
                        <button
                            class="size-8 border border-[#D5DFE4] buttonProduct bg-white rounded-[4px] flex justify-center items-center -translate-x-4 opacity-0 cursor-pointer transition-all duration-500 delay-[150ms]">
                    ...
                    <div
                        ...
                        <button
                            class="size-5 sm:size-7 border border-[#D5DFE4] bg-white rounded-[4px] flex justify-center items-center cursor-pointer productAnimation">
                        ...
                        <button
                            class="size-5 sm:size-7 border border-[#D5DFE4] bg-white rounded-[4px] flex justify-center items-center cursor-pointer">
                    ...
                    <span
                        class="inline-block absolute top-[5px] lg:top-2.5 right-[5px] lg:right-2.5 py-[3px] px-2 bg-[#D36B0B] text-white rounded-full text-[8px] lg:text-[12px] text-center z-[11]">18%</span>
                    <div>
                    ...
                    <div class="mb-1">
                        <a href="#" class="text-[12px] lg:text-[14px] text-[#425A8B]">تست آیتم</a>
                    </div>
                    ...
                    <div class="flex flex-row items-center mb-3 gap-2">
                        <div class="w-1/2 flex flex-row items-center text-[12px]">
                            <div class="text-[#8C9EC5] flex flex-row items-center">
                        ...
                        <div>
                            <span
                                class="lg:py-[3px] py-px px-0.5 lg:px-[5px] bg-[#0dcaf0] text-white rounded-full text-[10px]">
                                تستی
                            </span>
                        </div>
                    </div>
                    <div class="hidden lg:flex flex-row items-center gap-2 text-[#425A8B] mb-3 text-[18px] font-bold">
                        <span>$15.22</span>
                        <span>-</span>
                        <span>$140.00</span>
                    </div>
                    <div class="flex lg:hidden flex-row items-start gap-2 text-[#425A8B] mb-3 font-bold">
                        <span>$15.22</span>

                        <del class="text-xs text-[#8C9EC5]">$140.00</del>
                    </div>
                    <div class="flex flex-col lg:flex-row gap-2 lg:gap-4">
                        <div
                            class="w-full lg:w-1/2 flex flex-row justify-between items-center border border-[#D5DFE4] rounded-[10px] p-1">
                            <button
                                class="bg-[#F0F3F8] rounded-[10px] size-9 lg:size-[27px] flex items-center justify-center cursor-pointer">-</button>
                        ...
                        <div class="w-full lg:w-1/2">
                            <button
                                class="w-full h-full py-3 lg:py-1 text-[12px] lg:text-[14px] text-white bg-[#425A8B] leading-5 rounded-[10px] cursor-pointer">خرید</button>
                        </div>
                    </div>
                </div>
                <div class="p-2 md:p-3 lg:p-4 xl:p-5 border border-[#d5def4] rounded-[10px] relative productItem">
        ...
        <section class="text-[#425A8B] pt-3">
            <div class="grid grid-cols-1 sm:grid-cols-2 2xl:grid-cols-4 gap-[30px] py-10">
                <div class="bg-[#F0F3F8] p-2.5 rounded-[10px] flex flex-col lg:flex-row items-center gap-2.5">
                    <div class="lg:w-5/12">
            ...
            <div class="flex flex-col xl:flex-row items-start gap-10 py-10">
                ...
                <div
                    ...
                    <div class="rotate-y-180 h-[415px]">
                        ...
                        <div class="flex mt-3">
                            <a href="#"
                                class="flex flex-row items-center gap-2 bg-[#FD9636] rounded-[10px] py-2 px-5 text-white font-semibold">
                                <span>خرید</span>
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-4" viewBox="0 0 320 512">
                                    <path fill="#fff"
                                        d="M47 239c-9.4 9.4-9.4 24.6 0 33.9L207 433c9.4 9.4 24.6 9.4 33.9 0s9.4-24.6 0-33.9L97.9 256 241 113c9.4-9.4 9.4-24.6 0-33.9s-24.6-9.4-33.9 0L47 239z" />
                ...
                <div class="w-full children xl:w-3/4">
                    <div class="flex flex-row justify-between items-center pb-3">
                        ...
                        <div class="flex flex-row justify-end items-center gap-5">
                            <span
                                class="size-[35px] rounded-[12px] border border-[#d5def4] flex justify-center items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-5" viewBox="0 0 320 512">
                                    <path fill="#8C9EC5"
                                        d="M273 239c9.4 9.4 9.4 24.6 0 33.9L113 433c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9l143-143L79 113c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0L273 239z" />
                                </svg>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                        <div
                            class="p-2 md:p-3 lg:p-4 xl:p-5 border border-[#d5def4] rounded-[10px] relative productItem">
                            <div
                                class="absolute top-[5px] lg:top-2.5 left-[5px] lg:left-2.5 hidden md:flex flex-col gap-2 z-[555] overflow-hidden">
                            ...
                            <div
                                class="hidden lg:flex flex-row items-center gap-2 text-[#425A8B] mb-3 text-[18px] font-bold">
                                <span>$15.22</span>
                                <span>-</span>
                                <span>$140.00</span>
                            </div>
                        ...
                        <div
                            class="hidden md:block p-2 md:p-3 lg:p-4 xl:p-5 border border-[#d5def4] rounded-[10px] relative productItem">
                            <div
                                class="absolute top-[5px] lg:top-2.5 left-[5px] lg:left-2.5 hidden md:flex flex-col gap-2 z-[555] overflow-hidden">
        ...
        <section class="text-[#425A8B] pt-3">
            <div class="py-10">
                <div
                    class="flex flex-col xl:flex-row items-stretch gap-5 rounded-[10px] bg-[#425A8B] bg-[url('https://elango.steelthemes.com/ecom/el2/wp-content/uploads/2025/07/pattern-2.png')] bg-cover bg-no-repeat bg-center">
                    <div class="w-full xl:w-1/2 px-[50px] pt-[60px] pb-[70px] flex flex-col justify-start gap-5">
                        <div>
                            <h2 class="text-white sm:text-3xl lg:text-[50px] 2xl:leading-[75px] font-bold mb-1">
                        ...
                        <div class="w-full bg-white rounded-[10px] p-3">
                            <form action="" method="post">
                                <div class="rounded-[8px] 2xl:border-none border border-gray-300 relative">
                                    ...
                                    <button
                                        class="absolute left-3 top-2 2xl:static py-3 px-8 rounded-[8px] 2xl:mx-auto 2xl:block bg-[#425A8B] text-white hover:bg-[#334a76] transition-all duration-300">ثبت
                                        نام</button>
    ...
    <footer class="text-[#425A8B] pt-3">
        <div class="py-10 bg-[#F0F3F8]">
            <p class="text-center">
                طراحی شده توسط
