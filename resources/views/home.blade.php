        ...
        <section class="text-(--color-text) pt-3">
            <div class="flex flex-col xl:flex-row items-start gap-10 py-10">
                ...
                <div class="w-full children xl:w-3/4">
                    ...
                    <div class="flex flex-row items-start justify-between overflow-x-scroll gap-5" style="scrollbar-width: thin; scrollbar-color: var(--color-primary) var(--color-primary-text);">
