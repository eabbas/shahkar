            ...
            <div class="w-full children xl:w-3/4">
                <div class="w-full flex flex-row justify-between items-center pb-3">
                    ...
                    <div class="w-full flex flex-row justify-between items-center gap-5 font-bold overflow-x-auto p-5"
                        style="scrollbar-width: thin; scrollbar-color: var(--color-primary) var(--color-primary-text);">
                        <p class="cursor-pointer text-(--color-text)" onclick="getRelatedProducts('all')">
                            <span class="inline-block w-[100px]">
                                همه دسته ها
                            </span>
                        </p>
                        @foreach ($categories as $category)
                            <p class="cursor-pointer text-(--color-secondary-text)"
                ...
                <div class="flex flex-row items-start justify-between overflow-x-scroll gap-5"
                    style="scrollbar-width: thin; scrollbar-color: var(--color-primary) var(--color-primary-text);">
