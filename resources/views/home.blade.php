    ...
    <header class="2xl:container 2xl:px-4 mx-auto w-full border-b border-(--color-border) py-3">
                ...
                <ul class="w-6/12 hidden 2xl:flex flex-row justify-start items-center gap-4 text-(--color-text)">
                                ...
                                <div class="w-4/5">
                                    ...
                                    <div class="grid grid-cols-4 gap-4 max-h-[575px] overflow-y-auto">
                                        <div class="p-4 border border-(--color-border) rounded-[10px]">
                                            ...
                                            <span class="block text-center text-[14px] text-(--color-secondary-text)">تست آیتم</span>
                                            <span class="block text-center text-[12px] text-(--color-secondary-text)">10 آیتم</span>
                                        </div>
                                        <div class="p-4 border border-(--color-border) rounded-[10px]">
                                            <a href="#" class="block mb-1">
                                                <img src="https://elango.steelthemes.com/ecom/el2/wp-content/uploads/2025/07/category-1.png"
                    ...
                    <li>
                        <a href="{{route('aboutus-index')}}"
                            class="text-(--color-text) font-semibold text-sm gap-1 transition-all duration-300 py-4 menuLink">درباره ما</a>
                    </li>
                    <li>
                        <a href="{{route('contactus-create')}}"
                            class="text-(--color-text) font-semibold text-sm gap-1 transition-all duration-300 py-4 menuLink">تماس با ما</a>
                    </li>
            ...
            <div class="xl:w-4/12 w-full">
                <div class="flex flex-row md:justify-center xl:justify-end items-center gap-5">
                    <div class="flex items-center gap-5">
                        ...
                        @if($user)
                        <div>
                            <span class="block text-(--color-text) leading-[22px] font-medium text-sm">{{$user['name']}} {{$user['family']}}</span>
                            <a href="{{route('user.profile',[$user->id])}}" class="block text-(--color-text) leading-[22px] text-xs">مشاهده پروفایل</a>
                        </div>
                        @else
                        <div>
                            <a class="block text-(--color-text) leading-[22px] font-medium text-sm" href="{{route('user.login')}}">ورود</a>
                            <a class="block text-(--color-text) leading-[22px] text-xs" href="{{route('user.signup')}}">ثبت نام</a>
                        </div>
                        @endif
                    </div>
        ...
        <div class="w-11/12 mx-auto lg:hidden flex flex-row justify-between items-center py-4">
            ...
            <div class="flex flex-row justify-end items-center gap-5">
                ...
                <div class="size-7 p-1 flex flex-col gap-1 bg-(--color-primary-btn) rounded-sm cursor-pointer" id="chocIconMobile">
                    <div class="flex flex-row justify-between items-center">
                        <span class="size-1 bg-(--color-text) rounded-full"></span>
                        <span class="size-1 bg-(--color-text) rounded-full"></span>
                        <span class="size-1 bg-(--color-text) rounded-full"></span>
                        ...
                        <div class="w-full max-h-0 overflow-hidden transition-all duration-500 mt-2 subItem">
                            ...
                            <div class="w-full flex flex-col xl:flex-row items-start gap-10">
                                ...
                                <div class="w-full xl:w-3/4 xl:overflow-y-auto">
                                    <!-- contents -->
                                    <div class="grid sm:grid-cols-2 grid-cols-1 gap-4 max-h-[575px] overflow-y-auto text-(--color-text)">
                                        <div class="p-4 border border-(--color-border) rounded-[10px]">
                                            <a href="#" class="block mb-1">
                                                <img src="https://elango.steelthemes.com/ecom/el2/wp-content/uploads/2025/07/category-1.png"
                                                    class="w-[85px] h-20 mx-auto" alt="product">
                                            ...
                                            <span class="block text-center text-[14px] text-(--color-secondary-text)">تست
                                                آیتم</span>
    ...
    <main class="2xl:container 2xl:px-4 w-11/12 lg:w-[98%] mx-auto mt-5">
        ...
        <section class="text-(--color-text) pt-3">
            ...
            <div class="flex flex-row items-center gap-5 overflow-x-auto p-5">
                ...
                <div class="p-4 border border-(--color-border) rounded-[10px]">
                    ...
                    <span class="block text-center text-[14px] text-(--color-secondary-text) max-h-[42px] h-[42px]">{{$category->description}}</span>
                </div>
                @endforeach
            </div>
        ...
        <section class="text-(--color-text) pt-3">
            ...
            <div class="grid 2xl:grid-cols-6 grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2.5 lg:gap-5">
                ...
                <div class="p-2 md:p-3 lg:p-4 xl:p-5 border border-(--color-border) rounded-[10px] relative productItem">
                    <div
                        class="absolute top-[5px] lg:top-2.5 left-[5px] lg:left-2.5 hidden md:flex flex-col gap-2 z-555 overflow-hidden">
                    ...
                    <div>
                        <div class="mb-1">
                            <a href="{{route('product-show', [$specialDiscountProduct])}}" class="text-[12px] lg:text-[14px] text-(--color-text)">{{$specialDiscountProduct->title}}</a>
                        </div>
                        <div>
                            <div class="mb-2 font-semibold text-[14px] lg:text-base">
                ...
                <div class="w-full children xl:w-3/4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                        ...
                        <div
                            ...
                            <div class="mb-1">
                                <a href="http://localhost/shahkar/public/product/show/{{$product->id}}" class="text-[12px] lg:text-[14px] text-(--color-text)">{{$product->title}}</a>
                            </div>
                            <div class="mb-2 font-semibold text-[14px] lg:text-base">
