                ...
                <div class="md:flex md:flex-row md:w-full md:items-center md:gap-5">
                    ...
                    <div class="md:flex md:flex-col md:w-full">
                        ...
                        <fieldset class="mt-2 text-sm md:text-base border border-gray-400 rounded-[15px] py-1 pr-3">
                            <legend class="kelass p-1 w-30 bg-[#1cb7fd] text-white rounded-full flex justify-center text-sm">عکس</legend>

                            @if($teacher->profile_img)
                                <img src="{{ asset('storage/' . $teacher->profile_img) }}" 
                                     alt="Teacher Image" width="80" class="mb-2 rounded">
                            @endif

                            <input type="file" name="profile_img" class="w-full px-2 py-1 outline-none text-gray-500">
                        </fieldset>

                        <fieldset class="mt-2 text-sm md:text-base border border-gray-400 rounded-[15px] py-1 pr-3">
                            <legend class="p-1 w-30 bg-[#1cb7fd] text-white rounded-full flex justify-center text-sm">اسم</legend>
                    ...
                    <div class="md:flex md:flex-col md:w-full">
                        ...
                        <fieldset class="mt-2 text-sm md:text-base border border-gray-400 rounded-[15px] py-1 pr-3">
                            <legend class="p-1 w-30 bg-[#1cb7fd] text-white rounded-full flex justify-center text-sm">بیوگرافی</legend>
                    ...
                    <div class="md:flex md:flex-col md:w-full">
                        ...
                        <!-- تخصص -->
                        <fieldset class="mt-2 text-sm md:text-base border border-gray-400 rounded-[15px] py-1 pr-3">
                            <legend class="p-1 bg-[#1cb7fd] text-white rounded-full flex justify-center text-sm">تخصص</legend>
                    ...
                    <div class="md:flex md:flex-col md:w-full">
                        ...
                        <!-- شماره تلفن -->
                        <fieldset class="mt-2 text-sm md:text-base border border-gray-400 rounded-[15px] py-1 pr-3">
                            <legend class="p-1 bg-[#1cb7fd] text-white rounded-full flex justify-center text-sm">شماره تلفن</legend>
                ...
                <ul class="w-full px-4 py-3 mt-2">
                    ...
                    <li>
                        <fieldset class="mt-2 text-sm md:text-base border border-gray-400 rounded-[10px] py-1 pr-3">
                            ...
                            <input type="text" name="social_media[telegram]" 
