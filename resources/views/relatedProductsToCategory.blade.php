...
@section('title', 'محصولات مربوطه')
@section('content')

    <!-- address nav -->

    <nav class="w-full py-2 lg:py-5 flex flex-row items-center gap-3">
        <a href="#" class="text-xs leading-[2.17] text-(--color-secondary-text)">
            فروشگاه اینترنتی شاهکار
        </a>
        <span class="text-xs leading-[2.17] text-(--color-secondary-text)">/</span>
        <a href="#" class="text-xs leading-[2.17] text-(--color-secondary-text)">
            {{ $category->title }}
        </a>
    </nav>
    ...
    <section class="text-(--color-text)">
        <div class="flex flex-row gap-5">
            <aside class="min-w-[270px] w-[300px] hidden lg:block">
                ...
                <div class="sticky top-3 overflow-y-auto w-full border border-(--color-border) rounded-lg px-5 py-4">
                    <div class="text-lg font-bold mb-4 leading-[2.17]">
                        فیلتر ها
                    </div>
                    ...
                    <div class="w-full cursor-pointer sidebarFeatures">
                        <div class="w-full">
                            <div class="flex flex-row justify-between items-center py-3">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-4 transition-all duration-300"
                                    viewBox="0 0 448 512">
                        ...
                        <div class="w-full max-h-0 overflow-hidden pr-5 transitin-all duration-300 ease-in">
                            ...
                            <div
                                class="w-full flex flex-row justify-between items-center py-3 border-b border-(--color-border)">
                                <div class="flex flex-row items-center gap-3">
                                    <input type="checkbox">
                                    <label class="font-medium">آنر</label>
                                </div>
                                <span class="text-xs text-(--color-secondary-text)">Honor</span>
                            </div>
                            <div
                                class="w-full flex flex-row justify-between items-center py-3 border-b border-(--color-border)">
                                <div class="flex flex-row items-center gap-3">
                                ...
                                <span class="text-xs text-(--color-secondary-text)">Apple</span>
                            </div>
                            <div
                                class="w-full flex flex-row justify-between items-center py-3 border-b border-(--color-border)">
                                <div class="flex flex-row items-center gap-3">
                                ...
                                <span class="text-xs text-(--color-secondary-text)">Samsung</span>
                            </div>
                            <div
                                class="w-full flex flex-row justify-between items-center py-3 border-b border-(--color-border)">
                                <div class="flex flex-row items-center gap-3">
                                ...
                                <span class="text-xs text-(--color-secondary-text)">Xiaomi</span>
                            </div>
                    ...
                    <div class="w-full">
                        <div class="flex flex-row justify-between items-center py-3">
                            ...
                            <div class="w-10 h-5 border-2 border-gray-400 rounded-full cursor-pointer px-0.5 flex flex-row items-center justify-start transitin-all duration-300"
                                onclick="btn(this)">
                                <div class="size-3 bg-gray-400 rounded-full transitin-all duration-300 translate-x-0">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="w-full">
                <div class="w-full border-b border-(--color-border) lg:flex flex-row justify-between items-center hidden">
                    <div class="flex flex-row items-center gap-4">
                        ...
                        <ul class="flex flex-row items-center gap-4">
                            <li>
                                <a href="#" class="text-xs text-(--color-secondary-text) py-4">
                                    پرفروش ترین
                                </a>
                            </li>
                            <li>
                ...
                <div class="py-2 flex flex-row items-center overflow-x-auto lg:hidden">
                    ...
                    <div class="px-3 py-1 ml-2 rounded-full border border-(--color-border)">
                ...
                <div
                    class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 lg:divide-x lg:divide-y divide-(--color-border)">
                    @foreach ($foundProduct as $product)
                        <a href="{{ route('product-show', [$product]) }}" target="_blank"
                            class="lg:block flex flex-row w-full py-5 border-b border-(--color-border) lg:py-3 lg:px-2 productGrid">
                            <div class="mb-1 hidden lg:flex items-center h-4"></div>
                            <div class="w-1/3 lg:w-full relative">
                                <img src="{{ $product['img'] }}" class="block size-[118px] lg:size-60 m-auto"
                                    alt="product image">
                                <div
                            ...
                            <div class="w-2/3 lg:w-full">
                                ...
                                <h3 class="text-sm font-medium hidden lg:block leading-[2.17]">{{ $product->title }} <br>
                                    {{ $product->description }}</h3>
                                <h3 class="text-xs font-medium lg:hidden leading-[180%]">{{ $product->title }} <br>
                                    {{ $product->description }}</h3>
                                ...
                                <div class="pt-1 flex flex-row justify-end items-center">
                                    <span class="font-bold lg:text-base text-xs">{{ $product->price['price'] }}</span>
                                    <span class="text-xs">
                                        تومان
                                    </span>
                                </div>
