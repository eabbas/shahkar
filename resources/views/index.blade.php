                    ...
                    <div
                        ...
                        <div class="lg:w-4/12 w-full h-2/3 flex flex-col gap-7 justify-center items-center">
                            ...
                            <div
                                ...
                                <p class="text-center">{{ $header->subTitle }}</p>
                            </div>
                            <!-- bottoms -->
                            <div class="lg:w-full sm:w-9/12 w-full flex items-center justify-center py-5 ">
                                <a href="{{ $header->btnLink }}"
                                    ...
                                    <span
                                        class="xl:text-md sm:text-sm text-sm font-bold text-white">{{ $header->btnText }}</span>
                                    <div>
