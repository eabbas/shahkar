...
<head>
   ...
   <title>create footer form column</title>
</head>
...
<body>
   <div class="w-full pb-5 bg-[url('https://keenthemes.com/static/metronic/tailwind/dist/assets/media/images/2600x1200/bg-10.png')] bg-cover bg-no-repeat">
      <h2 class="text-3xl text-center font-bold py-5 text-[#425A8B]">فرم ایجاد ستون فرم فوتر</h2>
         ...
         <form action="{{route('footer-footerFormMedia-store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="flex flex-col w-full p-6 border border-[#D5DFE4] rounded-[10px]">
               <div class="pt-2 pb-5">
                  ...
                  <input class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-xl focus:bg-[#f1f1f4] w-full" type="text" name="title[4]" id="title" required>
               </div>
               <div class="pt-2 pb-5">
                  <label for="text">متن فرم :
                     <span class="text-rose-500">*</span>
                  </label>
                  <input class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-xl focus:bg-[#f1f1f4] w-full" type="text" name="text" id="text" required>
               </div>
               <div class="pt-2 pb-5">
                  <label for="placeholder">متن داخل اینپوت :
                     <span class="text-rose-500">*</span>
                  </label>
                  <input class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-xl focus:bg-[#f1f1f4] w-full" type="text" name="placeholder" id="placeholder" required>
               </div>
