...
<body class="bg-[#f8f8f8] max-w-[1700px] mx-auto">
    <header class="w-full lg:h-16 h-30 fixed top-3 flex justify-center items-center z-3">
        <div class="w-11/12 h-full rounded-2xl flex justify-between xl:justify-end bg-white shadow_boxs">
            <div class="xl:w-11/12 w-full h-full flex items-center justify-between max-lg:px-4 pr-4">
                <!-- hamburger_menu_svg -->
                ...
                <!-- hamburger_menu_svg -->
                <div class=" h-full xl:gap-20 flex gap-15 items-center max-lg:hidden">
                    ...
                    <!-- search_box_start -->
                    <div class="w-6/12 h-2/3 bg-white rounded-full flex justify-between items-center shadow_boxs px-6">
        ...
        <section class="w-full h-dvh fixed top-0 right-0 z-5 lg:hidden translate-x-full trasition-all duration-300"
            ...
            <div
                class="w-5/12 h-full bg-white rounded-4xl flex flex-col gap-3 items-center justify-between pt-9 relative pb-5">
                <div>
    ...
    <main class="max-lg:hidden">
        <!-- sub_heder_start -->
        <section
            class="w-full h-[89vh] flex flex-col gap-3 mt-21 bg-[url({{asset('assets/img/background_heder.jpg')}})] bg-cover bg-center md:hidden lg:flex">
            <div class="w-23/24 flex justify-between">
                <div class="w-8/12 flex">
                    <div class="w-3/12 flex items-end pb-20">
                        <img src="{{asset('assets/img/printer.png')}}" alt="" class="w-full object-fit">
                    </div>
                    <div class="w-9/12 flex flex-col gap-3 items-center">
                        <img src="{{asset('assets/img/logo.png')}}" alt="" class="w-8/12">
                        <div class="w-8/12 flex items-center text-[20px] font-bold justify-between px-2">
                            <span class="pl-4">چاپ بنر</span>
                            <span class="h-2/3 w-0.5 bg-red-500 rounded-full"></span>
                            <span class="px-4">تابلو سازی چلنیوم</span>
                            <span class="h-2/3 w-0.5 bg-red-500 rounded-full"></span>
                            <span class="pr-4">چاپ روی فلکس</span>
                        </div>
                        <div class="w-6/12 text-[20px] flex justify-center font-bold">
                            <p>ایده شما با کیفیت <span class="text-red-500">شاهکار</span> ما اجرا میشود.</p>
                        </div>
                        <div class="w-full h-full  flex items-center relative -right-10">
                            <div class="w-1/4 h-full flex flex-col justify-center items-center">
                                ...
                                <span class="text-lg font-bold">پشتبیانی حرفه ای</span>
                                <span class="text-sm text-[#515151]"> مشاوره رایگان</span>
                            </div>
                            ...
                            <div class="w-1/4 h-full flex flex-col justify-center items-center">
                                ...
                                <span class="text-lg font-bold">ضمانت کیفیت</span>
                                <span class="text-sm text-[#515151]">تضمین کیفیت چاپ</span>
                            </div>
                            <span class="w-0.5 h-7/12 bg-[#e8e8e8] rounded-full"></span>
                            ...
                            <div class="w-1/4 h-full flex flex-col justify-center items-center">
                                ...
                                <span class="text-lg font-bold">تحویل سریع</span>
                            ...
                            <div class="w-1/4 h-full flex flex-col justify-center items-center">
                                ...
                                <span class="text-lg font-bold">کیفیت رنگ بی نظیر</span>
                                <span class="text-sm text-[#515151]">چاپ با جدیدترین دستگاه ها</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="w-8/24 pl-4">
                    <!-- form_order -->
                    <div class="w-full bg-white rounded-4xl flex flex-col gap-5 items-center px-7 py-3 shadow_boxs">
                        ...
                        <div class="w-full flex gap-2 items-center justify-between">
                            <div
                                class="w-1/2 bg-white rounded-lg shadow_boxs_form_sub_heder flex gap-4 items-center px-4 py-3">
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="size-4">
                                        <path
                                            d="M304 128a80 80 0 1 0 -160 0 80 80 0 1 0 160 0zM96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128zM49.3 464H398.7c-8.9-63.3-63.3-112-129-112H178.3c-65.7 0-120.1 48.7-129 112zM0 482.3C0 383.8 79.8 304 178.3 304h91.4C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7H29.7C13.3 512 0 498.7 0 482.3z" />
                                ...
                                <input type="text" class="outline-none w-full text-sm font-bold"
                        ...
                        <div
                            class="w-full bg-white rounded-lg shadow_boxs_form_sub_heder flex gap-4 items-center justify-between px-4 py-3 ">
                            <div class=" flex gap-4 items-center">
                                <div>
                                ...
                                <span class="font-bold">نوع سفارش را انتخاب کنید</span>
                            </div>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="size-4">
                                    <path
                        ...
                        <div
                            ...
                            <textarea name="" rows="2" class="outline-none w-full text-sm font-bold"
                        ...
                        <div
                            ...
                            <label for="file"
                                ...
                                <div class="w-10/12 h-full flex items-center gap-4 justify-between px-4 py-2">
                                    <div class="flex flex-col justify-center items-center">
                                        <p>فایل خود را انتخاب کنید یا اینجا بکشید</p>
                                        <p class="text-[13px] text-[#918c8c]">10MBحداگثر حجم :JPG,PNG,PDF,AI,CDR,ZIP</p>
                                    </div>
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="size-8">
                                            <path
                        ...
                        <div class="w-full py-2 bg-red-500 flex gap-3 items-center justify-center rounded-xl">
                            <span class="text-xl font-bold text-white">ارسال سفارش</span>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    viewBox="0 0 20 20" id="entypo-direction" width="20" height="20" fill="white">
                                    <g>
                                        <path
            ...
            <div class="w-11/12 bg-white mx-auto flex flex-col items-end rounded-2xl shadow_boxs pb-2">
                <div class="w-11/12 h-full flex justify-between items-center py-2">
                    <div class="w-4/12 h-full flex gap-5 items-center justify-start">
                        <span class="w-0.5 h-8/12 bg-red-500 rounded-full"></span>
                    ...
                    <span class="w-0.5 h-full bg-[#e8e8e8]"></span>
                    <div class="w-8/12 h-full flex flex-col gap-4 px-7">
                        <div class="w-full flex gap-5 items-center justify-center">
                            <span class="w-full h-0.5 bg-[#e8e8e8] rounded-full"></span>
                            <span class="text-2xl font-bold flex justify-center items-center text-nowrap">ارتباط با
                                ما</span>
                            <span class="w-full h-0.5 bg-[#e8e8e8] rounded-full"></span>
                        </div>
                        <div class="w-full flex items-center justify-between">
                            <div class="w-1/4 h-full flex gap-4 justify-center items-center">
                                <div class="flex flex-col items-end justify-center">
                                    <span class="font-bold">صنعت چاپ در خدمت</span>
                                    <span class="font-bold">همه مشتریان عزیز</span>
                                </div>
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="size-8">
                                        <path
                            ...
                            <div class="w-1/4 h-full flex gap-4 justify-center items-center">
                                ...
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        viewBox="0 0 20 20" id="entypo-dribbble" class="size-8">
                                        <g>
                                            <path
                            ...
                            <span class="w-[2px] h-1/2 bg-[#e8e8e8] rounded-full"></span>
                            <div class="w-1/4 h-full flex gap-4 justify-center items-center">
                                <div class="flex flex-col items-end justify-center">
