...
<header class="w-full lg:h-dvh flex flex-col items-cener">
    ...
    <section class="w-full flex justify-center items-center fixed top-3 right-0 z-2">
        <div class="w-11/12 py-3 flex justify-between bg-[var(--background)] items-center px-3 rounded-2xl">
            ...
            <div class="max-lg:w-1/3 lg:w-1/5 h-full flex lg:items-center justify-center max-lg:justify-center justify-start cursor-pointer">
                <img src="{{asset('assets/img/logo.png')}}" alt="" class="object-fit lg:w-10/24 w-6/12 h-full">
            </div>
    ...
    <!-- sub_heder_start -->
    <section class="w-full xl:h-10/12 lg:h-full flex flex-col gap-2 items-center lg:items-start justify-between xl:mt-25  mt-23 relative">
        <div class="w-full h-full relative flex flex-col gap-3 justify-center items-center">
            <img src="{{asset('assets/img/background_sub_heder.jpg')}}" alt="" class="bg-center min-w-full lg:max-h-full lg:min-h-full max-lg:hidden">
            <img src="{{asset('assets/img/background_sub_heder_mobile.jpg')}}" alt="" class="w-full lg:hidden max-lg:order-1">

            {{--item--}}
            <div class="lg:w-23/24 w-11/12 lg:h-full max-lg:py-1.5 flex flex-col items-end justify-center py-5 lg:absolute lg:top-0 lg:right-0  max-lg:order-2 max-lg:mx-auto">
                <div class="lg:w-4/12 w-full h-2/3 flex flex-col gap-7 justify-center items-center">
                    <div class="xl:text-5xl sm:text-4xl text-4xl text-white font-bold flex flex-col sm:gap-8 gap-4 justify-center items-center">
                        <h2>چاپ حرفه‌ای</h2>
                        <h2>برای <span class="text-[var(--gold)]">برندهای</span> خاص</h2>
                    </div>
                    <div class="xl:text-lg lg:text-xs sm:text-lg text-sm text-[var(--text-secondary)] flex flex-col justify-center items-center">
                        <p>ز کارت ویزیت تا بیلبوردهای شهری،</p>
                        <p>با جدیدترین تکنولوژی روز دنیا، کیفیتی بی‌رقیب را تجربه کنید.</p>
                    </div>
                    <!-- bottoms -->
                    <div class="lg:w-full sm:w-9/12 w-full flex max-sm:flex-col gap-5 items-center justify-end py-5 ">
                        <a href="#" class="sm:w-1/2 w-full py-3 flex gap-3 justify-center items-center rounded-2xl gradient_box1 gradient_box1_hover_chang border-2 border-[var(--gold)] transition_root">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="xl:size-5 size-4" fill="white">
                        ...
                        <a href="#" class="sm:w-1/2 w-full py-3 flex gap-3 justify-center items-center rounded-2xl border-2 border-[var(--gold)] rezume_gradient transition_root">
                            <span class="xl:text-md sm:text-sm text-sm font-bold text-white">مشاهده نمونه کار ها</span>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="xl:size-5 size-4 fill-white rotate-180"><path d="M440.6 273.4c4.7-4.5 7.4-10.8 7.4-17.4s-2.7-12.8-7.4-17.4l-176-168c-9.6-9.2-24.8-8.8-33.9 .8s-8.8 24.8 .8 33.9L364.1 232 24 232c-13.3 0-24 10.7-24 24s10.7 24 24 24l340.1 0L231.4 406.6c-9.6 9.2-9.9 24.3-.8 33.9s24.3 9.9 33.9 .8l176-168z"></path></svg>
                            </div>
                        </a>
...
<main class="mt-20 flex flex-col gap-20 items-center">
    ...
    <section class="w-full h-full flex items-center justify-center">
        <div class="w-11/12 h-full flex flex-col gap-8 items-center justify-center">
            ...
            <div class="w-full grid lg:grid-cols-6 lg:grid-rows-1 sm:grid-cols-2 sm:grid-rows-3 grid-cols-1 gird-rows-6  xl:gap-4 gap-4 items-center justify-center sm:justify-between">
                <div class="w-full h-full border-1 relative border-[var(--gold)] bg-[#181819] rounded-2xl flex lg:flex-col items-center justify-between scale transition_root">
                    <div class="lg:w-full w-1/2 lg:h-7/12 h-full">
                        <img src="{{asset('assets/img/kart_servis.jpg')}}" alt="" class="object-fit w-full xl:h-50 lg:h-40 md:h-45 sm:h-39 h-40  lg:rounded-t-2xl rounded-2xl">
                    </div>
                    <div class="lg:w-full lg:h-5/12 max-lg:hidden bg-black/60 blur-[5px]  absolute bottom-0 left-0 rounded-b-2xl -z-0"></div>
                    <div class="lg:w-full w-1/2 h-full  text-white  rounded-b-2xl relative flex flex-col max-lg:gap-5 justify-end">
                        <div class="w-full lg:absolute lg:-top-10 lg:right-0 flex justify-center items-center">
                            <div class="lg:w-2/3 w-11/12 sm:pb-4 pb-2 sm:pt-2 pt-1 rounded-xl bg-[var(--background-2)] flex flex-col gap-1 items-center justify-center">
                                <div>
                                ...
                                <h4 class="xl:text-sm lg:text-xs sm:text-[10px] md:text-sm text-sm font-bold">چاپ کارت ویزیت</h4>
                            </div>
                        </div>
                        <div class="w-full flex flex-col gap-1 justify-center items-center xl:text-sm lg:text-xs sm:text-[11px] md:text-sm text-xs text-[var(--text-secondary)] pb-3 xl:pt-13 lg:pt-10">
                ...
                <div class="w-full h-full border-1 relative border-[var(--gold)] bg-[#181819] rounded-2xl flex lg:flex-col items-center justify-between scale transition_root">
                    <div class="lg:w-full w-1/2 lg:h-7/12">
                        <img src="{{asset('assets/img/bibord_servis.jpg')}}" alt="" class="object-fit w-full xl:h-50 lg:h-40 md:h-45 sm:h-39 h-40  lg:rounded-t-2xl rounded-2xl">
                    </div>
                    <div class="lg:w-full lg:h-5/12 max-lg:hidden bg-black/60 blur-[5px]  absolute bottom-0 left-0 rounded-b-2xl -z-0"></div>
                    <div class="lg:w-full w-1/2 h-full  text-white  rounded-b-2xl relative flex flex-col max-lg:gap-5 justify-end">
                        <div class="w-full lg:absolute lg:-top-10 lg:right-0 flex justify-center items-center">
    ...
    <!-- identify_vidio -->
        ...
        <section class="w-full flex items-center justify-center">
            <div class="w-11/12 h-full flex flex-col gap-10  justify-center items-center">
                ...
                <div class="w-full xl:h-120 lg:h-90 sm:h-60 flex max-sm:flex-col gap-3 max-sm:gap-6 justify-between max-sm:justify-center items-center">
                    <div class="sm:w-4/12 max-sm:w-full h-full flex flex-col gap-4 justify-center items-start max-sm:order-2">
                        <div class="w-full sm:h-1/3 max-sm:py-3 bg-[var(--background-2)] border-2 border-[var(--gold)] flex gap-7 justify-center items-center rounded-lg">
                            <div class="lg:p-2 p-1.5 rounded-full bg-[var(--background)] border border-[var(--gold)] flex justify-center items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="lg:size-6 size-3 fill-[var(--gold)]">
                                    <path
                                        d="M464 258.2c0 2.7-1 5.2-4.2 8c-3.8 3.1-10.1 5.8-17.8 5.8H344c-53 0-96 43-96 96c0 6.8 .7 13.4 2.1 19.8c3.3 15.7 10.2 31.1 14.4 40.6l0 0c.7 1.6 1.4 3 1.9 4.3c5 11.5 5.6 15.4 5.6 17.1c0 5.3-1.9 9.5-3.8 11.8c-.9 1.1-1.6 1.6-2 1.8c-.3 .2-.8 .3-1.6 .4c-2.9 .1-5.7 .2-8.6 .2C141.1 464 48 370.9 48 256S141.1 48 256 48s208 93.1 208 208c0 .7 0 1.4 0 2.2zm48 .5c0-.9 0-1.8 0-2.7C512 114.6 397.4 0 256 0S0 114.6 0 256S114.6 512 256 512c3.5 0 7.1-.1 10.6-.2c31.8-1.3 53.4-30.1 53.4-62c0-14.5-6.1-28.3-12.1-42c-4.3-9.8-8.7-19.7-10.8-29.9c-.7-3.2-1-6.5-1-9.9c0-26.5 21.5-48 48-48h97.9c36.5 0 69.7-24.8 70.1-61.3zM160 256a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zm0-64a32 32 0 1 0 0-64 32 32 0 1 0 0 64zm128-64a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zm64 64a32 32 0 1 0 0-64 32 32 0 1 0 0 64z" />
                                </svg>
                            </div>
                            <div class="flex flex-col gap-2 justify-center items-center">
                                ...
                                <span class="xl:text-lg lg:text-md text-xs font-bold text-[var(--text)]">تجربه درخشان</span>
                            </div>
                        </div>
                        <div class="w-full sm:h-1/3 max-sm:py-3 bg-[var(--background-2)] border-2 border-[var(--gold)] flex gap-7 justify-center items-center rounded-lg">
                            <div class="p-2 rounded-full bg-[var(--background)] border border-[var(--gold)] flex justify-center items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                            ...
                            <div class="flex flex-col gap-2 justify-center items-center">
                                ...
                                <span class="xl:text-lg lg:text-md text-xs font-bold text-[var(--text)]">پروژه موفق</span>
                            </div>
                        </div>
                        <div class="w-full sm:h-1/3 max-sm:py-3 bg-[var(--background-2)] border-2 border-[var(--gold)] flex gap-7 justify-center items-center rounded-lg">
                            <div class="p-2 rounded-full bg-[var(--background)] border border-[var(--gold)] flex justify-center items-center">
                            ...
                            <div class="flex flex-col gap-2 justify-center items-center">
                                ...
                                <span class="xl:text-lg lg:text-md text-xs font-bold text-[var(--text)]">رضایت مشتری</span>
                            </div>
                        </div>
                    </div>
                    <div class="sm:w-8/12 max-sm:w-full h-full border-2 border-[var(--gold)] relative flex justify-center items-center rounded-lg max-sm:order-1">
                        <video src="{{asset('assets/img/identify_vidio.mkv')}}" controls  class="object-fit w-full h-full rounded-lg" onclick="vidio_onclic_play()"></video>
                        <!-- <div class="w-full h-full flex justify-center items-center  top-0 right-0" onclick="play_vidio_identify(this)"> -->
                        <div class="p-4 bg-[var(--background)]  border-2 border-[var(--gold)] absolute flex justify-center items-center rounded-full animation_play_vidio transition-all duration-300" id="play_icon_vidio">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="size-6 fill-white"><path d="M73 39c-14.8-9.1-33.4-9.4-48.5-.9S0 62.6 0 80V432c0 17.4 9.4 33.4 24.5 41.9s33.7 8.1 48.5-.9L361 297c14.3-8.7 23-24.2 23-41s-8.7-32.2-23-41L73 39z"/></svg>
                        </div>
                        <!-- </div> -->
                    </div>
                </div>
    ...
    <section class="w-full flex flex-col items-center justify-center">
        <div class="w-11/12 h-full flex flex-col lg:gap-8 sm:gap-6 gap-5 items-center">
            ...
            <div class="w-full flex justify-center items-center">
                <div class="overflow-auto [&::-webkit-scrollbar]:h-2  [&::-webkit-scrollbar-thumb]:bg-[var(--gold)]  [&::-webkit-scrollbar-thumb]:rounded-full flex gap-2 items-center xl:text-md sm:text-sm text-xs py-4 px-1">
                    <span class="px-6 py-2 bg-[var(--gold)] rounded-full font-bold text-white flex justify-center items-center shadow_item cursor-pointer">همه</span>
                    <span class="px-6 py-2 border border-[var(--border)] hover:border-[var(--gold)] rounded-full font-bold text-[var(--text-secondary)] scale hover:text-[var(--text)] transition_root flex justify-center items-center shadow_item text-nowrap cursor-pointer">تابلو سازی</span>
                    <span class="px-6 py-2 border border-[var(--border)] hover:border-[var(--gold)] rounded-full font-bold text-[var(--text-secondary)] scale hover:text-[var(--text)] transition_root flex justify-center items-center shadow_item text-nowrap cursor-pointer">تابلو سازی</span>
                    <span class="px-6 py-2 border border-[var(--border)] hover:border-[var(--gold)] rounded-full font-bold text-[var(--text-secondary)] scale hover:text-[var(--text)] transition_root flex justify-center items-center shadow_item text-nowrap cursor-pointer">تابلو سازی</span>
                    <span class="px-6 py-2 border border-[var(--border)] hover:border-[var(--gold)] rounded-full font-bold text-[var(--text-secondary)] scale hover:text-[var(--text)] transition_root flex justify-center items-center shadow_item text-nowrap cursor-pointer">تابلو سازی</span>
                    <span class="px-6 py-2 border border-[var(--border)] hover:border-[var(--gold)] rounded-full font-bold text-[var(--text-secondary)] scale hover:text-[var(--text)] transition_root flex justify-center items-center shadow_item text-nowrap cursor-pointer">تابلو سازی</span>
            ...
            <!-- category_rezume -->
            <!-- rezumes items -->
            <div class="max-w-full min-w-full flex xl:h-100 lg:h-80 md:h-50 sm:h-45 h-40 items-center xl:justify-between gap-2">
                <div class="w-5/24 h-full border border-[var(--gold)] rounded-xl px-[0.3px] py-[0.7px] max-sm:hidden overflow-hidden">
                    <img src="{{asset('assets/img/poster_desk.jpg')}}" alt="" class="object-fit w-full h-full rounded-xl scale transition_root">
                </div>
                <div class="w-6/12 h-full flex flex-col justify-between items-center">
                    <div class="w-full h-49/100 flex gap-2 justify-between items-center">
                        <div class="sm:w-1/2 w-full h-full border border-[var(--gold)] rounded-xl px-[0.3px] py-[0.7px] overflow-hidden">
                            <img src="{{asset('assets/img/kart_rezume.jpg')}}" alt="" class="object-fit w-full h-full rounded-xl scale transition_root">
                        </div>
                        <div class="w-1/2 h-full max-sm:hidden border border-[var(--gold)] rounded-xl px-[0.3px] py-[0.7px] overflow-hidden">
                            <img src="{{asset('assets/img/kart_rezume.jpg')}}" alt="" class="object-fit w-full h-full rounded-xl scale transition_root">
                        </div>
                    </div>
                    <div class="w-full h-49/100 flex gap-1 justify-between items-center">
                        <div class="sm:w-1/3 w-1/2 h-full border border-[var(--gold)] rounded-xl px-[0.3px] py-[0.7px] overflow-hidden">
                            <img src="{{asset('assets/img/kart_rezume.jpg')}}" alt="" class="object-fit w-full h-full rounded-xl scale transition_root">
                        </div>
                        <div class="sm:w-1/3 w-1/2 h-full border border-[var(--gold)] rounded-xl px-[0.3px] py-[0.7px] overflow-hidden">
                            <img src="{{asset('assets/img/kart_rezume.jpg')}}" alt="" class="object-fit w-full h-full rounded-xl scale transition_root">
                        </div>
                        <div class="sm:w-1/3 w-1/2 max-sm:hidden h-full border border-[var(--gold)] rounded-xl px-[0.3px] py-[0.7px] overflow-hidden">
                            <img src="{{asset('assets/img/kart_rezume.jpg')}}" alt="" class="object-fit w-full h-full rounded-xl scale transition_root">
                        </div>
                    </div>
                </div>
                <div class="sm:w-7/24 max-sm:w-1/2 h-full border border-[var(--gold)] rounded-xl px-[0.3px] py-[0.7px] overflow-hidden">
                    <img src="{{asset('assets/img/bibord_servis.jpg')}}" alt="" class="object-fit w-full h-full rounded-xl scale transition_root">
                </div>
            ...
            <!-- rezumes items -->
            <!-- show all rezume -->
            <a href="#" class="px-10 py-2 flex gap-8 justify-center items-center rounded-2xl border-2 border-[var(--border)] hover:border-[var(--gold)] transition_root">
    ...
    <section class="w-full flex justify-center items-center">
        <div class="w-full lg:h-full h-full flex justify-center items-center relative">
            <img src="{{asset('assets/img/background_commant.jpg')}}" alt="" class="object-fit w-full h-85 max-lg:hidden">
            ...
            <div class="w-full h-full lg:absolute lg:bottom-0 lg:right-0 flex flex-col items-center justify-start">
                <div class="w-11/12 h-full flex flex-col gap-9">
                    <!-- property -->
                    <div class="w-full lg:h-30 lg:border-y-1 lg:border-[var(--border)] max-lg:border sm:border-[var(--gold)] flex max-sm:flex-col gap-3 items-center justify-between lg:py-4 py-2 lg:px-5 max-sm:bg-[var(--background)] max-lg:bg-[var(--background-2)]">
                        <div class="sm:w-3/14 w-full h-full flex lg:gap-4  sm:justify-center max-sm:justify-end items-center max-lg:bg-[var(--background)] max-lg:rounded-xl max-lg:border-1 sm:border-[var(--border)] border-[var(--gold)] max-lg:py-2">
                            <div class="group max-sm:w-9/12 msx-sm:h-full flex max-lg:flex-col max-sm:flex-row gap-2 jsutify-start items-center">

                                <div class="group-hover:scale-[1.05] group-active:scale-[1.3] transition_root">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="xl:size-13 lg:size-9 size-7 fill-[var(--gold)]"><path d="M73 127L256 49.4 439 127c5.9 2.5 9.1 7.8 9 12.8c-.4 91.4-38.4 249.3-186.3 320.1c-3.6 1.7-7.8 1.7-11.3 0C102.4 389 64.5 231.2 64 139.7c0-5 3.1-10.2 9-12.8zM457.7 82.8L269.4 2.9C265.2 1 260.7 0 256 0s-9.2 1-13.4 2.9L54.3 82.8c-22 9.3-38.4 31-38.3 57.2c.5 99.2 41.3 280.7 213.6 363.2c16.7 8 36.1 8 52.8 0C454.8 420.7 495.5 239.2 496 140c.1-26.2-16.3-47.9-38.3-57.2zM369 209c9.4-9.4 9.4-24.6 0-33.9s-24.6-9.4-33.9 0l-111 111-47-47c-9.4-9.4-24.6-9.4-33.9 0s-9.4 24.6 0 33.9l64 64c9.4 9.4 24.6 9.4 33.9 0L369 209z"></path></svg>
                                </div>
                                <div class="flex flex-col sm:gap-2 gap-1 lg:items-start items-center max-sm:items-start justify-center">
                                    <h5 class="xl:text-lg sm:text-xs text-sm font-bold text-[var(--text)]">کیفیت تضمینی</h5>
                                    <div class="flex flex-col lg:items-start items-center max-sm:items-start justify-center xl:text-[11px] sm:text-[7px] text-[10px] text-[var(--text-secondary)]">
                        ...
                        <div class="sm:w-4/14 w-full h-full flex lg:gap-4  sm:justify-center max-sm:justify-end items-center max-lg:bg-[var(--background)] max-lg:rounded-xl max-lg:border-1 sm:border-[var(--border)] border-[var(--gold)] max-lg:py-2 gradient_box1 rounded-xl">
                            <div class="group max-sm:w-9/12 msx-sm:h-full flex max-lg:flex-col max-sm:flex-row gap-2 jsutify-start items-center">
                                ...
                                <div class="flex flex-col sm:gap-2 gap-1 lg:items-start items-center max-sm:items-start justify-center">
                                    <h5 class="xl:text-lg text-md font-bold text-[var(--text)]">چرا ما را انتخاب کنید</h5>
                                    <div class="flex flex-col lg:items-start items-center max-sm:items-start justify-center xl:text-[11px] text-[10px] text-[var(--text)]">
                                        <span class=" font-bold">استفاده از رنگ با کیفیت عالی</span>
                                        <span class="font-bold">با دستگاه های پیشرفته</span>
                                    </div>
                                </div>
                        ...
                        <div class="sm:w-3/14 w-full h-full flex lg:gap-4  sm:justify-center max-sm:justify-end items-center max-lg:bg-[var(--background)] max-lg:rounded-xl max-lg:border-1 sm:border-[var(--border)] border-[var(--gold)] max-lg:py-2">
                            <div class="group max-sm:w-9/12 msx-sm:h-full flex max-lg:flex-col max-sm:flex-row gap-2 jsutify-start items-center">
                                ...
                                <div class="group-hover:scale-[1.05] group-active:scale-[1.3] transition_root">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="xl:size-13 lg:size-9 size-7" stroke="var(--gold)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <div class="flex flex-col sm:gap-2 gap-1 lg:items-start items-center max-sm:items-start justify-center">
                                    <h5 class="xl:text-lg sm:text-xs text-sm font-bold text-[var(--text)]">تحویل سریع</h5>
                                    <div class="flex flex-col lg:items-start items-center max-sm:items-start justify-center xl:text-[11px] sm:text-[7px]  text-[10px] text-[var(--text-secondary)]">
                                        <span class=" font-bold">استفاده از رنگ با کیفیت عالی</span>
                                        <span class="font-bold">با دستگاه های پیشرفته</span>
                                    </div>
                        ...
                        <div class="sm:w-3/14 w-full h-full flex lg:gap-4  sm:justify-center max-sm:justify-end items-center max-lg:bg-[var(--background)] max-lg:rounded-xl max-lg:border-1 sm:border-[var(--border)] border-[var(--gold)] max-lg:py-2">
                            <div class="group max-sm:w-9/12 msx-sm:h-full flex max-lg:flex-col max-sm:flex-row gap-2 jsutify-start items-center">
                                ...
                                <div class="group-hover:scale-[1.05] group-active:scale-[1.3] transition_root">
                                    <svg class="xl:size-13 lg:size-9 size-7" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <!-- Circle -->
                                        <circle
                                                cx="32"
                                                cy="32"
                                        ...
                                        <!-- Top & Bottom marks -->
                                        <line x1="32" y1="6" x2="32" y2="11" stroke="#D4A437" stroke-width="3" stroke-linecap="round"/>
                                        <line x1="32" y1="53" x2="32" y2="58" stroke="#D4A437" stroke-width="3" stroke-linecap="round"/>
                                ...
                                <div class="flex flex-col sm:gap-2 gap-1 lg:items-start items-center max-sm:items-start justify-center">
                                    <h5 class="xl:text-lg sm:text-xs text-sm font-bold text-[var(--text)]">قیمت مناسب</h5>
                                    <div class="flex flex-col lg:items-start items-center max-sm:items-start justify-center xl:text-[11px] sm:text-[7px] text-[10px] text-[var(--text-secondary)]">
                                        <span class=" font-bold">استفاده از رنگ با کیفیت عالی</span>
                                        <span class="font-bold">با دستگاه های پیشرفته</span>
                                    </div>
                    ...
                    <div class="w-full flex max-sm:flex-col max-sm:gap-4 justify-between items-center">
                        <div class="sm:w-32/100 w-full h-full gradient_comment_box flex flex-col gap-4 items-center justify-center border border-[var(--gold)] rounded-xl py-4 scale transition_root">
                            <!-- star -->
                            <div class="flex gap-0.5 items-center justify-center max-sm:hidden">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="size-4 fill-[var(--star)]"><defs></defs><path class="fa-secondary" d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"/><path class="fa-primary" d=""/></svg>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="size-4 fill-[var(--star)]"><defs></defs><path class="fa-secondary" d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"/><path class="fa-primary" d=""/></svg>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="size-4 fill-[var(--star)]"><defs></defs><path class="fa-secondary" d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"/><path class="fa-primary" d=""/></svg>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="size-4 fill-[var(--star)]"><defs></defs><path class="fa-secondary" d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"/><path class="fa-primary" d=""/></svg>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="size-4 fill-[var(--star)]"><defs></defs><path class="fa-secondary" d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"/><path class="fa-primary" d=""/></svg>
                            ...
                            <!-- star -->
                            <!-- comment_ttem -->
                            <p class="xl:w-9/12 w-11/12 xl:text-sm lg:text-xs sm:text-[9px] md:text-[10px] text-xs text-center text-[var(--text-secondary)]">چاپ شاهکار با سال‌ها تجربه در زمینه چاپ دیجیتال و تبلیغات محیطی، همراه مطمئن شما در مسیر برندسازی و معرفی کسب‌وکار است</p>
                            <!-- comment_ttem -->
                            <div class="max-sm:w-full flex max-sm:justify-between justify-center max-sm:items-center max-sm:px-5">
                                <div class="xl:w-1/2 sm:w-10/12 w-1/2 flex justify-center max-sm:justify-start items-center gap-4">
                                    <img src="{{asset('assets/img/user.png')}}" alt="" class="object-cover lg:size-10 sm:size-6 size-7 rounded-full bg-white">
                                    <div class="flex flex-col items-start justify-center">
                                        <h5 class="xl:text-sm lg:text-xs sm:text-[9px] md:text-[10px] text-xs font-bold text-[var(--text)] text-nowrap">محمد مهدی بندعلی</h5>
                                        <span class="xl:text-xs lg:text-[11px] sm:text-[9px] md:text-[10px] text-[11px] text-[var(--text-secondary)] font-bold text-nowrap">طراح سابت</span>
...
<footer class="w-full mt-20 flex justify-center items-start bg-[var(--background-2)] border-t-1 border-[var(--border)] pt-6">
    <section class="w-11/12 flex max-lg:flex-col gap-4 lg:justify-between items-start">
            ...
            <div class="sm:w-1/2 w-full h-full flex flex-col gap-2 sm:items-start items-center justify-start">
                ...
                <div class="flex flex-col gap-2 items-start">
                    ...
                    <div class="flex justify-center items-center gap-4">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="lg:size-4 size-3 fill-[var(--gold)]">
                        ...
                        <span class="xl:text-lg sm:text-sm font-bold text-[var(--text-secondary)]">09925718265</span>
                    </div>
                    <div class="flex justify-center items-center gap-4">
                        <div>
                            <svg viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg" class="lg:size-4 size-3 fill-[var(--gold)]"><path d="M1664 1504v-768q-32 36-69 66-268 206-426 338-51 43-83 67t-86.5 48.5-102.5 24.5h-2q-48 0-102.5-24.5t-86.5-48.5-83-67q-158-132-426-338-37-30-69-66v768q0 13 9.5 22.5t22.5 9.5h1472q13 0 22.5-9.5t9.5-22.5zm0-1051v-24.5l-.5-13-3-12.5-5.5-9-9-7.5-14-2.5h-1472q-13 0-22.5 9.5t-9.5 22.5q0 168 147 284 193 152 401 317 6 5 35 29.5t46 37.5 44.5 31.5 50.5 27.5 43 9h2q20 0 43-9t50.5-27.5 44.5-31.5 46-37.5 35-29.5q208-165 401-317 54-43 100.5-115.5t46.5-131.5zm128-37v1088q0 66-47 113t-113 47h-1472q-66 0-113-47t-47-113v-1088q0-66 47-113t113-47h1472q66 0 113 47t47 113z"></path></svg>
                        </div>
                        <span class="xl:text-lg sm:text-sm font-bold text-[var(--text-secondary)]">@gmail.com</span>
                    </div>
                    <div class="flex justify-center items-center gap-4">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="lg:size-4 size-3 fill-[var(--gold)]"><path d="M336 192c0-79.5-64.5-144-144-144S48 112.5 48 192c0 16.3 7.7 42 24.7 75.4c16.4 32.2 38.8 66.4 62.1 98.3c20.3 27.9 40.7 53.3 57.2 73.1c16.5-19.8 36.9-45.2 57.2-73.1c23.2-31.9 45.6-66.2 62.1-98.3C328.3 234 336 208.3 336 192zm48 0c0 83.1-105.6 219-160.2 283.6C204.8 498.1 192 512 192 512s-12.8-13.9-31.8-36.4C105.6 411 0 275.1 0 192C0 86 86 0 192 0S384 86 384 192zm-160 0a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zm-112 0a80 80 0 1 1 160 0 80 80 0 1 1 -160 0z"/></svg>
                        </div>
                        <span class="xl:text-lg sm:text-sm font-bold text-[var(--text-secondary)]">آذربایجان شرقی بناب</span>
                    </div>
                </div>
            ...
            <div class="sm:w-1/2 w-full h-full flex flex-col justify-start items-center">
                <div class="flex w-full h-full pb-15">
                    <div class="w-1/2 h-full flex flex-col gap-3 justify-start sm:items-start items-center">
                        ...
                        <div class="w-full flex flex-col gap-1 sm:items-start items-center justify-start xl:text-md lg:text-sm text-xs font-bold text-[#A4A4A5]">
                    ...
                    <div class="w-1/2 h-full flex flex-col gap-3 justify-start sm:items-start items-center">
                        ...
                        <div class="flex flex-col gap-1 sm:items-start items-center justify-start xl:text-md lg:text-sm text-xs font-bold text-[#A4A4A5]">
                            <span>چاپ بنر و فلکس</span>
                            <span>چاپ بنر و فلکس</span>
                            <span>چاپ بنر و فلکس</span>
                            <span>چاپ بنر و فلکس</span>
                ...
                <div class="flex flex-col gap-1 items-center justify-center sm:hidden lg:flex">
                    <p class="xl:text-[15px] lg:text-[12px] text-[13px] text-[var(--text-secondary)]">طراحی و توسعه <span class="font-bold">شرکت اندیشه گران طراحان دیجیتال<span class="text-[var(--gold)]">( فائوس)</span> </span></p>
                    <span class="xl:text-[15px] lg:text-[12px] text-[15px] font-bold text-[var(--gold)]">09147794595</span>
                </div>
            </div>
            <!-- servis -->
        </div>
        ...
        <div class="lg:w-7/24 w-full h-full flex flex-col justify-center items-start">
            <div class="flex flex-col gap-3 justify-center lg:items-start items-center">
                ...
                <p class="w-10/12 xl:text-lg text-sm font-bold text-[var(--text-secondary)]  max-lg:text-center">چاپ <span class="text-[var(--gold)]">شاهکار</span> با سال‌ها تجربه در زمینه چاپ دیجیتال و تبلیغات محیطی، همراه مطمئن شما در مسیر برندسازی و معرفی کسب‌وکار است.</p>
            </div>
            <!-- social_network_svg -->
            <div class="w-full py-6 flex items-center justify-center gap-10">
                <div class="p-2 rounded-full bg-[var(--background)] border border-[var(--gold)] flex justify-center items-center cursor-pointer scale transition_root">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
        ...
        <div class="mx-auto flex flex-col gap-1 items-center justify-center lg:hidden max-sm:hidden">
            <p class="text-[17px] text-[var(--text-secondary)]">طراحی و توسعه <span class="font-bold">شرکت اندیشه گران طراحان دیجیتال<span class="text-[var(--gold)]">( فائوس)</span> </span></p>
