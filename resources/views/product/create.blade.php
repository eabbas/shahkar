            ...
            <div class="flex flex-col md:flex-row gap-3 md:gap-5">
               <div class="w-2/3">
                  <div class="w-full flex flex-col">
                     ...
                     <input type="text" class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-xl focus:bg-[#f1f1f4]" name="title" id="title" placeholder="نام محصول را وارد کنید" required>
                  </div>
                  ...
                  <div class="flex flex-row justify-between items-center gap-3 lg:gap-5 mt-3 lg:mt-5">
                     ...
                     <div class="md:w-1/2 flex flex-col">
                        ...
                        <input type="text" class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-xl focus:bg-[#f1f1f4]" placeholder="برند" name="brand" id="brand">
                     </div>
                  </div>
                  <div class="flex flex-col items-center gap-3 md:gap-5">
                     <div id="attribute" class="w-full flex flex-col gap-3 md:gap-5"></div>
               ...
               <div class="w-1/3">
                  ...
                  <div class="w-full flex flex-col gap-3 md:gap-5 mt-3 lg:mt-5">
                     <div class="w-full flex flex-col gap-3">
                        ...
                        <input type="number" class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-xl focus:bg-[#f1f1f4]" name="price" id="price">
                     </div>
                     <div class="w-full flex flex-col gap-3">
