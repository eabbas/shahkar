      ...
      <div class="w-2/3 mx-auto border border-[#D5DFE4] rounded-[10px] text-[#425A8B] p-5 bg-white">
         <form action="{{route('product-update')}}" method="post">
            ...
            <div class="w-full flex flex-col">
               ...
               <input type="text" class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-[12px] focus:bg-[#f1f1f4]" name="title" id="title" placeholder="نام محصول را وارد کنید" required value="{{$product->title}}">
            </div>
            ...
            <div class="flex flex-col-reverse md:flex-row gap-5 md:gap-10 mt-5">
               <div class="md:w-1/2 flex flex-col">
                  ...
                  <input type="file" class="w-fit outline-none pr-5 py-3 bg-[#F9F9F9] rounded-[12px] focus:bg-[#f1f1f4]" name="image" id="image" value="{{$product->image}}">
               </div>
               <div class="md:w-1/2 flex flex-col">
