      ...
      <div class="w-2/3 mx-auto border border-[#D5DFE4] rounded-[10px] text-[#425A8B] p-5 bg-white">
         <form action="{{route('product-update')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="w-full flex flex-col">
               ...
               <input type="text" class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-[12px] focus:bg-[#f1f1f4]" name="title" id="title" placeholder="نام محصول را وارد کنید" value="{{$product->title}}" required>
            </div>
            <div class="w-full flex flex-col mt-5">
               <label for="description" class="mb-2">توضیحات محصول:</label>
               <textarea name="description" class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-[12px] focus:bg-[#f1f1f4]" rows="4" id="description" placeholder="توضیحات محصول را وارد کنید">{{$product->description}}</textarea>
            </div>
            <div class="flex flex-col-reverse md:flex-row gap-5 md:gap-10 mt-5">
               <div class="md:w-1/2 flex flex-col">
                  <label for="mainImage" class="mb-2">عکس اصلی:</label>
                  <input type="file" class="w-full outline-none pr-5 py-3 bg-[#F9F9F9] rounded-[12px] focus:bg-[#f1f1f4]" name="mainImage" id="mainImage">
               </div>
               <div class="md:w-1/2 flex flex-col">
                  <label for="gallery" class="mb-2">گالری تصاویر :</label>
                  <input type="file" class="w-full outline-none pr-5 py-3 bg-[#F9F9F9] rounded-[12px] focus:bg-[#f1f1f4]" name="gallery[]" id="gallery" multiple>
               </div>
               <div class="md:w-1/2 flex flex-col">
                  <label for="summary" class="mb-2">خلاصه محصول:</label>
                  <input type="text" class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-[12px] focus:bg-[#f1f1f4]" placeholder="خلاصه" name="summary" id="summary" value="{{$product->summary}}">
               </div>
            </div>
            <div class="flex flex-row justify-between items-center gap-3 lg:gap-5 mt-3 lg:mt-5">
               ...
               <div class="md:w-1/2 flex flex-col">
                  ...
                  <input type="text" class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-[12px] focus:bg-[#f1f1f4]" placeholder="برند" name="brand" id="brand" value="{{ $product->brand }}">
               </div>
            </div>
            <div class="w-full md:w-1/2 flex flex-row items-center gap-3 mt-3 lg:mt-5">
