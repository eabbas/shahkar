...
<section class="2xl:container mx-auto">
    <div class="w-11/12 mx-auto">
        <div class="my-10">
            <h1 class="lg:text-3xl md:text-2xl text-md font-semibold text-center text-gray-700">لیست کاربران دوره {{$course -> title}} </h1>
        </div>
    ...
    <tbody>
        ...
        <tr class="border-b border-gray-400">
            ...
            <td class="px-4 py-2 flex justify-start gap-2">
                <a href="{{ route('userCourse.edit',  [$course['id']]) }}" class="px-2 py-1 bg-blue-500 text-white rounded-md hover:bg-blue-600">ویرایش دره کاربر</a>
                <a href="{{ route('userCourse.delete', [$course['id']]) }}" class="px-2 py-1 bg-red-400 text-white rounded-md hover:bg-red-500">حذف دوره</a>
            </td>
        </tr>
        @endforeach
    </tbody>
