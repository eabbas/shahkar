...
<body>
    ...
    <main class="w-full lg:h-dvh flex flex-row items-center p-4">
        <div class="w-full lg:w-1/2 lg:h-full p-4 lg:p-10 flex flex-col items-center gap-10">
            <h2 class="text-2xl font-bold text-gray-800 text-center mt-10">فراموشی رمز عبور</h2>
            ...
            <form action="{{ route('user.setPassword') }}" method="post" class="w-9/12 flex flex-col gap-4"
                id="setPassForm">
                @csrf
                <div class="w-full">
                    <input type="number"
