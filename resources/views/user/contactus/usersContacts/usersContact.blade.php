...
@section('title', 'شاهکار | لیست درخواست های من')
    @section('content')
{{--         
   ...
   <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">
            ...
            <form class="flex flex-col gap-5" action="{{ route('contactus-deleteAllUser') }}" method="post">
                @csrf
                ...
                <div
                    ...
                    <div
                        class="w-full flex flex-row lg:grid lg:grid-cols-8 items-center divide-x divide-[#f1f1f4] sticky -top-5">
                    ...
                    <div class="bg-white divide-y divide-[#f1f1f4]">
                        ...
                        @endphp
                       @foreach($user->contactuss as $contactus)
                            <div class="w-full flex flex-row lg:grid lg:grid-cols-8 items-center divide-x divide-[#f1f1f4]">
                                <div
                                    ...
                                    <div class="w-10 lg:w-full">
                                        <input type="checkbox" class="check" name="contacts[]" value="{{ $contactus->id }}">
                                    </div>
                                </div>
                                <div
                                    class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center">
                                ...
                                <div
                                    class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center">
                                    <span class="block w-20 lg:w-full">{{$contactus['user']['name']}} {{$contactus['user']['family']}}</span>
                                </div>
                                <div
                                    class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center col-span-4">
                                    <span class="block w-[200px] lg:w-full">{{$contactus['description']}}</span>
                                </div>
                                
                                <div>
                                    <ul class="w-[90px] lg:w-full text-sm mt-1 rounded-sm p-1 grid grid-cols-2">
                                        
                                        <li class="flex justify-center">
                                            <a href="{{ route('contactus-usersContact-edit', [$contactus]) }}"
                                        ...
                                        <li class="flex justify-center">
                                            <a href="{{ route('contactus-usersContact-delete', [$contactus]) }}"
