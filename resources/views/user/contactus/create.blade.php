         ...
         <form action="{{route('contactus-store')}}" method="post" class="flex flex-col items-stretch justify-center gap-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
               <div class="flex flex-col">
                  ...
                  <input type="text" class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-xl focus:bg-[#f1f1f4]" name="name" id="name" placeholder="نام را وارد کنید" required>
               </div>
               <div class="flex flex-col">
                  ...
                  <input type="text" class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-xl focus:bg-[#f1f1f4]" name="family" id="family" placeholder="نام خانوادگی را وارد کنید" required>
               </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
               <div class="flex flex-col">
                  ...
                  <input type="email" class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-xl focus:bg-[#f1f1f4]" name="email" id="email" placeholder="ایمیل را وارد کنید" required>
               </div>
               <div class="flex flex-col">
                  ...
                  <input type="number" class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-xl focus:bg-[#f1f1f4]" name="phoneNum" id="phoneNum" placeholder="شماره تماس را وارد کنید" required>
               </div>
            </div>
            <div class="">
               <div class="flex flex-col">
                  ...
                  <textarea class="h-40 outline-none pr-5 py-3 bg-[#F9F9F9] rounded-xl focus:bg-[#f1f1f4]" name="description" id="description" placeholder="توضیحات را وارد کنید" required></textarea>
               </div>
            </div>
