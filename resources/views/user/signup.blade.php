...
<body>
    <section class="2xl:container mx-auto">
        <div class="w-11/12 mx-auto">
            ...
            <form action="{{ route('user_store') }}" method="post" class="w-11/12 lg:w-3/4 mx-auto p-5 rounded-lg border">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-5 lg:gap-10">
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" name="name" id="first_name" class="w-full px-2 py-1 lg:px-5 lg:px-2 outline-none border-b" required>
                    </div>
                    <div class="w-full flex flex-col">
                        <label class="text-sm md:text-base" for="last_name">نام خانوادگی :</label>
                        <input type="text" name="family" id="last_name" class="w-full px-2 py-1 lg:px-5 lg:px-2 outline-none border-b" required>
                    </div>
                    <div class="w-full flex flex-col">
                        <label class="text-sm md:text-base" for="email">ایمیل :</label>
                        <input type="email" name="email" id="email" class="w-full px-2 py-1 lg:px-5 lg:px-2 outline-none border-b" required>
                    </div>
                    <div class="w-full flex flex-col">
                        <label class="text-sm md:text-base" for="password">رمز عبور :</label>
