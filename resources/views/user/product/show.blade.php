                ...
                <div
                    ...
                    <div
                        ...
                        @foreach ($product['media'] as $media)
                            <div
                                class="max-sm:w-1/5 bg-red-500  flex justify-center items-center rounded-xl border-2 border-[var(--border)] hover:border-[var(--gold)] active:border-[var(--gold)] transition_root cursor-pointer">
