        ...
        <div class="w-full flex max-sm:flex-col justify-between items-start gap-5">
            ...
            <div
                ...
                <div
                    ...
                    <div
                        class="max-sm:w-1/5 w-full bg-red-500 xl:h-30/100 lg:h-27/100 sm:h-30/100 h-full flex justify-center items-center rounded-xl border-2 border-[var(--border)] hover:border-[var(--gold)] active:border-[var(--gold)] transition_root cursor-pointer">
