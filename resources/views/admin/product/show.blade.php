...
<body>
    ...
    @section('content')
        <header class="2xl:container mx-auto 2xl:px-4 w-full border-b border-[var(--color-border)] py-3">
            ...
            <div class="2xl:w-full w-[98%] mx-auto lg:flex xl:flex-row hidden lg:flex-col items-center gap-5">
                <div class="xl:w-8/12 w-full flex flex-row justify-center gap-5 xl:justify-start items-center">
                    ...
                    <ul class="w-6/12 hidden 2xl:flex flex-row justify-start items-center gap-4 text-[var(--color-text)]">
                        <li>
                            <a href="#" class="font-bold text-sm gap-1 transition-all duration-300 py-4 menuLink">
                                خانه
                            </a>
                        </li>
                        ...
                        <li class="relative menuItemParent">
                            <a href="#"
                                class="text-[var(--color-text)] font-bold text-sm flex flex-row items-center gap-1 transition-all duration-300 py-4 menuLink">
                                <span>
                                    فروشگاه
                                </span>
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-3" viewBox="0 0 448 512">
                            ...
                            <ul
                                ...
                                <li>
                                    <a href="#"
                                        class="block py-2.5 text-sm font-bold transitin-all duration-300 hover:text-[var(--color-primary)]">عنوان
                                        تستی</a>
                                </li>
                                <li>
                                    <a href="#"
                        ...
                        <li>
                            <a href="#"
                                class="text-[var(--color-text)] font-bold text-sm gap-1 transition-all duration-300 py-4 menuLink">
                    ...
                    <div class="flex flex-row md:justify-center xl:justify-end items-center gap-5">
                        <div class="flex items-center gap-5">
                            ...
                            @if (Auth::user())
                                <div>
                                    <span
                                        class="block text-[var(--color-text)] leading-[22px] font-medium text-sm">{{ Auth::user()['name'] }}
                                        {{ Auth::user()['family'] }}</span>
                                    <a href="{{ route('user.profile', [Auth::user()->id]) }}"
                                        class="block text-[var(--color-text)] leading-[22px] text-xs">مشاهده پروفایل</a>
                                </div>
                            @else
                                <div>
                                    <a class="block text-[var(--color-text)] leading-[22px] font-medium text-sm"
                                        href="{{ route('user.login') }}">ورود</a>
                                    <a class="block text-[var(--color-text)] leading-[22px] text-xs"
            ...
            <div class="w-11/12 mx-auto lg:hidden flex flex-row justify-between items-center py-4">
                ...
                <div class="flex flex-row justify-end items-center gap-5">
                    <a href="#" class="inline-block w-5 h-4 relative">
            ...
            <div class="fixed z-[9999] w-full h-svh bg-black/70 top-0 -right-full transition-all duration-500"
                ...
                <div class="relative w-11/12 mx-auto mt-5 bg-white rounded-md h-[565px] p-7 opacity-0  transition-all duration-300 delay-600"
                    ...
                    <ul class="w-full h-[444px] overflow-y-auto">
                        <li class="my-1">
                            <a href="#"
                                class="inline-block w-full text-[var(--color-text)] font-bold py-3 transition-all duration-300 px-3 rounded-lg hover:bg-[var(--color-primary-btn-hover)]">
                                خانه
                            </a>
                        </li>
                        <li class="my-1">
                            <div
                                ...
                                <a href="#" class="inline-block w-11/12 text-[var(--color-text)] font-bold py-3 ">
                                    دسته بندی
                                </a>
        ...
        <main class="2xl:container 2xl:px-4 w-[97%] mx-auto">
            <!-- address navbar -->
            <section
                class="w-full px-2 lg:px-0 lg:mb-5 py-5 flex flex-row justify-between items-center text-[var(--color-secondary-text)] text-xs lg:text-sm">
            ...
            <section class="text-[var(--color-text)] ">
                <div class="flex flex-col lg:flex-row">
                    <div class="lg:ml-4 shrink-0 flex flex-col-reverse lg:flex-col lg:w-[36%] overflow-hidden">
                        <div
                            class="flex gap-3 items-center justify-between px-2 py-2 lg:mb-5 bg-[var(--color-primary)]/20 text-[var(--color-discount-bg)] border-t-2 rounded-t-[19px] lg:hidden border-[--color-discount-bg]">
                            <div>
                        ...
                        <div
                            class="lg:flex gap-3 items-center justify-between px-2 py-2 lg:mb-5 bg-[var(--color-primary)]/20 text-[var(--color-discount-bg)] hidden">
                            <div>
                                <span class="font-bold">
                                    پیشنهاد شگفت انگیز
                                </span>
                                    ...
                                    @foreach ($product->medias as $media)
                                        @if ($media->is_main)
                                            <img class="w-full rounded-large overflow-hidden inline-block"
                                                src="{{ asset('/storage/' . $media->path) }}" alt="product image">
                                        @endif
                                    @endforeach
                                </div>
                                <div
                            ...
                            <div class="w-full overflow-x-auto touch-pan-x" style="scrollbar-width:none;">
                                <div class="hidden lg:flex flex-row items-center mt-5 mb-3 ">
                                    @foreach ($product->medias as $media)
                                        @if (!$media->is_main)
                                            <div
                                                class="cursor-pointer rounded border border-[var(--color-border)] p-1 ml-2">
                        ...
                        <div class="w-full lg:w-1/2 xl:w-7/12">
                            <div class="flex items-center w-full lg:px-0 pt-4 lg:pt-0 px-2">
                                <nav class="flex items-center text-sm lg:text-base">
                                    <a href="#"
                                        class="text-[var(--color-text)] border-b border-[var(--color-border)] lg:border-none lg:text-[var(--color-primary)] text-xs lg:text-base">{{ $product->category->title }}</a>
                                    ...
                                    <a href="#"
                                        class="text-[var(--color-text)] border-b border-[var(--color-border)] lg:border-none lg:text-[var(--color-primary)] text-xs lg:text-base">
                                        {{ $product->title }}
                                    </a>
                                </nav>
                            </div>
                            <h1
                                class="text-md xl:text-3xl text-[var(--color-text)] font-bold mt-3 mb-2 pointer-events-none px-2 lg:px-0">
                                {{ $product->title }}
                            </h1>
                            <div class="lg:pb-5 mb-5 lg:border-b border-[var(--color-border)]  px-2 lg:px-0">
                            ...
                            <div class="lg:hidden border-b border-[var(--color-border)]  px-2 lg:px-0">
                                <div
                                    ...
                                    <span class="text-[var(--color-text)] text-xs">
                            ...
                            <div
                                class="py-3 flex flex-col gap-3 font-bold text-[var(--color-text)] border-b border-[var(--color-border)] lg:border-none  px-2 lg:px-0">
                                <div class="flex flex-row items-center text-sm lg:text-base">
                                    <span>رنگ : </span>
                                    <div class="flex flex-row items-center gap-1.5">
                                        <span> مشکی </span>
                                        <span class="size-4 rounded-full"
                                            style="background-color: rgb(33, 33, 33)"></span>
                                    </div>
                                </div>
                                <div class="w-full">
                                    <span
                            ...
                            <div class="flex flex-col-reverse lg:flex-col">
                                <div class="mb-4 lg:mb-2  px-2 lg:px-0">
                                    <p class="py-3 text-md font-bold text-[var(--color-text)]">بیمه</p>
                                            ...
                                            <div>
                                                ...
                                                <div class="flex items-center ml-auto">
                                                    <div class="flex flex-row items-center ml-1">
                                                        ...
                                                        <div
                                                            class="text-[var(--color-secondary-text)] leading-[1.5] line-through font-bold md:text-sm text-xs">
                                                            30,800
                                                        </div>
                                                    </div>
                                                    <div
                                ...
                                <div
                                    class="w-full lg:pt-2 pb-3 lg:pb-0 border-b border-[var(--color-border)] lg:border-none text-[var(--color-text)]  px-2 lg:px-0">
                                    <h3 class="text-lg font-bold py-3 hidden lg:block">
                                        ویژگی ها
                                    </h3>
                                    <h3
                                        class="text-md font-bold py-3 lg:hidden flex felx-row justify-between items-center">
                                        <span>ویژگی ها</span>
                                ...
                                <div class="hidden lg:flex flex-row gap-4 justify-center items-center mt-4">
                                    ...
                                    <button
                                        ...
                                        <span class="text-[var(--color-text)] text-sm font-bold">
                                            مشاهده ویژگی ها
                                        </span>
                                        <svg xmlns="http://www.w3.org/2000/svg" class="size-4" viewBox="0 0 320 512">
                                            <path fill="var(--color-fill)"
                            ...
                            <div class="lg:hidden py-5 px-2 text-[var(--color-text)]">
                                ...
                                <a href="#" class="flex flex-row gap-3 items-center">
                                    ...
                                    <div class="w-full flex flex-col gap-2 py-4 border-b border-[var(--color-border)]">
                                        <div class="flex flex-row items-center">
                                            ...
                                            <span
                                                class="rounded-full bg-[var(--color-primary-btn)] text-xs text-[var(--color-primary)] leading-[180%] px-2 mr-2 font-bold">
                                                رسمی
                                            </span>
                                            <span
                                                class="rounded-full bg-[var(--color-primary-btn)] text-xs text-[var(--color-primary)] leading-[180%] px-2 mr-2 font-bold">
                                        ...
                                        <div class="flex flex-row items-center gap-1.5">
                                            <div
                                                class="flex flex-row items-center gap-1.5 py-0.5 pr-2 pl-0.5 border border-[var(--color-border)] rounded-full text-xs font-bold">
                                                رضایت از کالا
                                                <span
                                ...
                                <div class="flex flex-row gap-3 items-start">
                                    ...
                                    <div class="w-full flex flex-col gap-2 py-4 border-b border-[var(--color-border)]">
                                        <div
                                            class="text-xs font-medium leading-[180%] flex flex-row justify-between items-center">
                                            <span>
                                        ...
                                        <div
                                            class="text-xs font-medium leading-[180%] flex flex-row justify-start items-center">
                                        ...
                                        <div
                                            class="text-sm font-bold leading-[180%] flex flex-row justify-start items-center">
                            ...
                            <div class="lg:hidden py-5 px-2 text-[var(--color-text)]">
                                ...
                                <div class="flex flex-row gap-3 items-start">
                                    ...
                                    <div class="w-full flex flex-col gap-2 py-4 border-b border-[var(--color-border)]">
                                        <div
                                            class="text-sm font-medium leading-[180%] flex flex-row justify-between items-center">
                                            <span>
                                                شرایط بازگشت کالا
                                            </span>
                                            <svg xmlns="http://www.w3.org/2000/svg" class="size-4" viewBox="0 0 320 512">
                        ...
                        <div class="hidden lg:block lg:w-1/2 xl:w-5/12">
                            <div class="sticky top-10">
                                <div
                                    ...
                                    <div
                                        class="flex flex-row items-start gap-4 py-4 border-b border-[var(--color-border)]">
                                        ...
                                        <div class="flex flex-row justify-end">
                                            <div>
                                                ...
                                                <div class="flex flex-row gap-1 mt-1 items-end">
                                                    <span class="text-lg font-bold">{{ $product->price->discount }}</span>
                                    ...
                                    <div class="w-full flex flex-col gap-2 py-4 border-b border-[var(--color-border)]">
                                        ...
                                        <div class="pr-5 border-r-2 mr-2 border-[var(--color-border)]">
                                            ...
                                            <div
                                                class="text-sm font-bold leading-[180%] flex flex-row justify-start items-center py-1 relative before:absolute before:content-[''] before:size-1.5 before:rounded-full before:bg-[var(--color-primary)] before:-right-[24px]">
                                    ...
                                    <div class="pt-4 flex flex-row items-center">
                                        <img class="size-6" src="https://www.digikala.com/statics/img/svg/club-point.svg"
                                            alt="">
                                        <span class="text-xs font-bold text-[var(--color-text)] mr-5">
                                            83 امتیاز دیجی کلاب
                                        </span>
                                        <div
                                ...
                                <div>
                                    <a href="#"
                                        class="flex flex-row justify-between items-center border border-[var(--color-border)] rounded-md mt-2 py-3 px-2">
                                        <div class="flex flex-row items-center">
                                            <div
            ...
            <section class="text-[var(--color-text)] ">
                <div class="hidden lg:block pt-2 pb-3 mt-4 rounded-lg border border-b-4 border-[var(--color-border)] px-2">
                    <div class="py-3">
            ...
            <section class="text-[var(--color-text)] ">
                <div
                    class="hidden lg:block pt-2 pb-3 mt-4 rounded-lg border border-b-4 border-[var(--color-border)] px-2">
                    <div class="py-3">
                        <h2 class="font-bold leading-[2.17]">
                            ویدئو های مرتبط
                        </h2>
            ...
            <section class="text-[var(--color-text)] mt-4 lg:pb-10">
                                ...
                                <div class="mt-4 pt-4 flex flex-row items-start">
                                    ...
                                    <div class="lg:w-4/5 overflow-x-auto lg:overflow-visible"
                                        ...
                                        <div class="hidden lg:block py-4 border-b border-[var(--color-border)]">
                                            ...
                                            <div class="flex flex-row items-center gap-3">
                                                <span
                                                    class="text-sm font-medium px-2 py-2 leading-[1.5] rounded-full border border-[var(--color-border)] cursor-pointer">
                                                    قیمت و ارزش خرید
                                                </span>
                                                <span
                                                    class="text-sm font-medium px-2 py-2 leading-[1.5] rounded-full border border-[var(--color-border)] cursor-pointer">
                                            ...
                                            @foreach ($product->comments as $comment)
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="lg:mt-6">
                                                            <p
                                                                class="hidden lg:block text-sm text-justify leading-[2.17]">
                                                                {{ $comment->comment }}
                                                            </p>
                                                            <p
                                                        ...
                                                        <div class="hidden lg:block mt-2">
                                                            <a href="#"
                                                                class="leading-[2.17] flex flex-row items-center gap-2">
                                                                <span
                                                                    class="text-xs font-medium text-[var(--color-secondary)]">
                                                                    ادامه
                                                                </span>
                                                                <svg xmlns="http://www.w3.org/2000/svg" class="size-3"
                                                                    viewBox="0 0 320 512">
                                                        ...
                                                        <div class="flex flex-row justify-between items-center mt-7">
                                                            <span
                                                                class="lg:hidden text-xs text-[var(--color-secondary-text)]">
                                                                {{ $comment->created_at }}
                                                            </span>
                                                            ...
                                                            <div class="flex flex-row items-center gap-4">
                                                                <button class="flex flex-row items-center gap-2">
                                                                    ...
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        class="size-4" viewBox="0 0 512 512">
                                                                        <path fill="var(--color-fill)"
                        ...
                        <div>
                            ...
                            <div class="mt-4 pt-4 flex flex-row items-start overflow-x-auto lg:overflow-x-clip px-2 lg:px-0"
                                ...
                                <div class="lg:w-4/5 flex flex-row lg:block">
                                    ...
                                    <!-- comment -->
                                    <div
                                        class="p-4 lg:p-0 rounded-lg border border-[var(--color-border)] lg:border-none min-w-[308px] max-w-[308px] lg:min-w-full lg:max-w-full ml-3 lg:ml-0">
                                        @foreach ($questions as $question)
                                            @if ($product->id == $question->product_id)
                                                <div
                                                    class="p-4 lg:p-0 rounded-lg border border-[var(--color-border)] lg:border-none w-full lg:max-w-full">
                                                    <div class="lg:py-4 lg:border-b border-[var(--color-border)]">
                                                        <h3
                                                            class="hidden lg:block text-sm lg:text-md pb-2 lg:pb-0 lg:py-2 font-medium leading-[180%] lg:leading-[2.17]">
                                                            {{ $question->text }}
                                                        </h3>
                                                        <h3
                                                            class="lg:hidden block text-sm lg:text-md pb-2 lg:pb-0 lg:py-2 font-medium leading-[180%] lg:leading-[2.17]">
                                                            {{ $question->text }}
                                                        </h3>
                                                        ...
                                                        @foreach ($answers as $answer)
                                                            @if ($answer->question_id == $question->id && $answer->parent_id == 0)
                                                                <div
                                                                    class="rounded-lg border lg:border-none border-[var(--color-border)] px-3 py-2 lg:px-0 lg:py-0 bg-[var(--color-secondary-bg)] lg:bg-inherit">
                                                                    <div class="flex flex-row items-center py-2">
                                                                        <div class="flex flex-row gap-2 items-center">
                                                                            <div class="size-10">
                                                                                <img class="size-full rounded-full"
                                                                                    src="https://dkstatics-public.digikala.com/digikala-content-x-profile/79e1a2b23332632135d587ca943b5b2f8bf8ea6e_1742409752.jpg?x-oss-process=image/resize,m_lfit,h_300,w_300/quality,q_80"
                                                                                    alt="user profile">
                                                                            </div>
                                                                            <div class="flex flex-row items-center gap-2">
                                                                                <span class="text-xs font-medium">

                                                                                    {{ $answer->user?->name ?? 'کاربر ناشناس' }}
                                                                                    {{ $answer->user?->family }}
                    ...
                    <div class="w-3/12 hidden 2xl:block">
                        <div
                            ...
                            <div class="flex flex-row gap-5 items-start pb-3 mb-3 border-b border-[var(--color-border)]">
                                <div class="size-20">
                                    <img class="size-full" src="{{ asset('/storage/' . $media->path) }}"
                                        alt="product image">
                                </div>
                                <div>
                                    ...
                                    <div class="flex flex-row gap-4 items-center">
                                        <div class="size-[14px] rounded-full"
                ...
                <div class="lg:hidden p-5">
                    <a href="#" class="flex flex-row justify-between items-center">
                        <div class="flex flex-row items-center gap-2">
                            <div
                                class="size-9 rounded-full bg-[var(--color-secondary-bg)] flex justify-center items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-5" viewBox="0 0 512 512">
                                    <path fill="var(--color-fill)"
            ...
            <div class="fixed bg-black/30 inset-0 z-[1111] text-[var(--color-text)] transition-all duration-500 opacity-0 invisible"
                ...
                <div
                    ...
                    <div class="w-full px-2 py-3 border-b-2 border-[var(--color-border)]">
                        <div class="flex flex-row items-center">
                    ...
                    <div class="w-full">
                        <form class="p-4" action="{{ route('comment.store') }}" method="post">
                            ...
                            <div class="py-4">
                                <button
                                    class="rounded-lg block w-full leading-[2.17] text-[var(--color-primary-text)] bg-[var(--color-primary)] text-center py-3 px-2 cursor-pointer">
                                    ثبت دیدگاه
                                </button>
                            </div>
                        </form>
        ...
        <div
            class="w-full px-2 py-3 bg-white fixed bottom-0 right-0 lg:hidden border-t border-[var(--color-border)] text-[var(--color-text)]">
            <div class="flex flex-row justify-between items-center py-2">
                <div class="w-1/2">
                    <button
                        class="block font-medium w-full rounded-lg text-white bg-[var(--color-primary)] leading-[180%] text-sm text-center py-2">
                        افزودن به سبد خرید
                    </button>
                </div>
