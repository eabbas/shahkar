    ...
    @section('content')
        <header class="2xl:container mx-auto w-full border-b border-gray-300">
            ...
            <div class="w-11/12 mx-auto hidden lg:flex flex-row justify-between items-center py-7">
                ...
                <div class="w-3/12 flex flex-row justify-end items-center gap-3">
                    <span class="text-sm font-bold text-gray-600"> {{ $user->name }} {{ $user->family }}</span>
                    <img src="https://picsum.photos/200/300" class="size-10 rounded-full border-2 border-gray-500"
                        alt="user picture">
                </div>
            </div>
            <!-- desktop menu -->
            ...
            <div class="lg:hidden w-11/12 mx-auto py-2 flex flex-row justify-between items-center">
                <div class="flex flex-row justify-start items-center gap-3">
                    <img src="https://picsum.photos/200/300" class="size-10 rounded-full border-2 border-gray-500"
                        alt="user picture">
                    <span class="text-xs font-bold text-gray-600">حاج محمد اکبرنژاد</span>
                </div>
                ...
                <div class="fixed top-0 -right-full w-full h-svh bg-black/50 flex flex-row transition-all duration-500 ease-in-out"
                    id="hamburgerMenu">
                    <div class="w-8/12 h-full bg-white">
                        <div class="border-b border-gray-300 p-2">
                            <div class="w-full flex flex-row justify-start items-center gap-3">
                                <img src="https://picsum.photos/200/300"
                                    class="size-10 rounded-full border-2 border-gray-500" alt="user picture">
                                <span class="text-xs font-bold text-gray-600">حاج محمد اکبرنژاد</span>
                            </div>
                        </div>
                            ...
                            <ul class="w-full p-2">
                                <li class="border-b border-gray-300">
                                    <a href="{{ route('user.edit', ['user' => $user]) }}"
                                        class="inline-block w-full py-3 px-4 text-sm">ادیت پروفایل</a>
                                </li>
                                <li class="border-b border-gray-300">
                                    <a href="{{ route('user.delete', ['user' => $user]) }}"
                                        class="inline-block w-full py-3 px-4 text-sm">حذف حساب کاربری</a>
                                </li>
                                <li class="border-b border-gray-300">
                                    <a href="{{ route('user.logout') }}" class="inline-block w-full py-3 px-4 text-sm">خروج
                                        از حساب کاربری</a>
                                </li>
                                ...
                                @if ($user->is_admin)
                                    <li class="border-b border-gray-300">
                                        <a href="{{ route('user.index') }}"
                                            class="inline-block w-full py-3 px-4 text-sm">نمایش کاربران</a>
                                    </li>
                                @endif
        ...
        <main class="w-full flex flex-row">
            ...
            <aside class="hidden w-3/12 lg:h-[500px] border-l border-gray-300 lg:block">
                <ul class="w-full p-2">
                    <li class="border-b border-gray-300">
                        <a href="{{ route('user.edit', [$user]) }}" class="inline-block w-full py-3 px-4 text-sm">ادیت
                            پروفایل</a>
                    </li>
                    <li class="border-b border-gray-300">
                        <a href="{{ route('user.delete', [$user]) }}" class="inline-block w-full py-3 px-4 text-sm">حذف
                            حساب کاربری</a>
                    </li>
                    <li class="border-b border-gray-300">
                        <a href="{{ route('user.logout') }}" class="inline-block w-full py-3 px-4 text-sm">خروج از حساب
                            کاربری</a>
                    </li>

                    @if ($user->is_admin)
                        <li class="border-b border-gray-300">
                            <a href="{{ route('user.index') }}" class="inline-block w-full py-3 px-4 text-sm">نمایش
                                کاربران</a>
                        </li>
                    @endif
