...
@section('content')
    {{-- <section class="2xl:container mx-auto">
        <div class="w-11/12 mx-auto">
            <div class="my-10">
                <h1 class="lg:text-3xl md:text-2xl text-md font-bold text-center text-gray-700">لیست کاربران</h1>
            </div>
            ...
            <div class="overflow-x-auto">
                ...
                <div class="w-[890px] xl:w-full mx-auto">
                    <ul
                        class="grid grid-cols-7 gap-3 md:gap-5 lg:gap-10 text-center text-gray-700 font-bold xl:text-lg border-b-2 border-gray-400 pb-3 mb-3">


                        <li class="w-full">آیدی</li>
                        <li class="w-full">نام</li>
                        <li class="w-full">نام خانوادگی</li>
                        <li class="w-full">ایمیل</li>
                ...
                @foreach ($users as $user)
                    <div class="w-[890px] xl:w-full mx-auto">
                        <ul
                            class="grid grid-cols-7 gap-3 md:gap-5 xl:gap-10 text-center text-gray-700 font-medium text-sm md:text-base border-b border-gray-400 pb-5 my-5">
                            <li class="w-full"> {{ $user->id }}</li>
                            <li class="w-full"> {{ $user->name }}</li>
                            <li class="w-full"> {{ $user->family }}</li>
                            ...
                            <li class="w-full col-span-2 grid grid-cols-3 gap-3 xl:gap-5">
                                <div class="w-full">
                                    <a href="{{ route('user.adminCourses', [$user]) }}"
                                        class="px-3 xl:px-5 py-1 border border-gray-300 rounded-md transition-all duration-150 hover:bg-gray-400 hover:text-white">دوره
                                        ها</a>
                                </div>
                                <div class="w-full">
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-3">
                            <span class="block w-[220px] lg:w-full">عملیات</span>
                        </div>
                    </div>
                        ...
                        @foreach ($users as $user)
                            <div
                                ...
                                <div class="col-span-3">
                                    <div class="w-[220px] lg:w-full grid grid-cols-3 items-center gap-3">
                                        {{-- شرط اگر کاربر دوره ای داشت این لینک رو بیاره براش --}}
                                        <div
                                            class="p-1 lg:p-3 text-xs text-center lg:text-sm h-full flex items-center justify-center font-medium">
                                            <a href="{{ route('user.adminCourses', [$user]) }}" class="text-sky-700">
                                                دوره ها
                                            </a>
                                        </div>
                                        {{-- اتمام شرط --}}
                                        <ul class="text-sm mt-1 rounded-sm p-1 grid grid-cols-3 col-span-2">
