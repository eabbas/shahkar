   ...
   @section('title', 'شاهکار | راه های ارتباطی کاربران')
   @section('content')
   ...
   <table border="1" style="border-collapse: collapse;">
    ...
    <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">
            <h2 class="text-lg font-bold text-gray-800 p-4 text-center">لیست راه های ارتباطی کاربران</h2>
            <form class="flex flex-col gap-5" action="{{ route('homeForm-deleteAll') }}" method="post">
                @csrf
                            ...
                            <div class="w-full flex flex-row lg:grid lg:grid-cols-5 items-center divide-x divide-[#f1f1f4]">
                                <div
                                    ...
                                    <div class="w-10 lg:w-full">
                                        <input type="checkbox" class="check" name="rows[]" value="{{ $homeForm->id }}">
                                    </div>
                                </div>
                                <div
                                    class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center">
                                ...
                                <div
                                    ...
                                    <span class="block w-20 lg:w-full">{{ $homeForm->contactMethod }}</span>
                                </div>
                                ...
                                <div>
                                    <ul class="w-[120px] lg:w-full text-sm mt-1 rounded-sm p-1 grid grid-cols-2">
                                        ...
                                        <li class="flex justify-center">
                                            <a href="{{ route('homeForm-edit',[$homeForm]) }}"
                                        ...
                                        <li class="flex justify-center">
                                            <a href="{{ route('homeForm-delete',[$homeForm]) }}"
