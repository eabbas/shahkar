      ...
      <div class="w-2/3 mx-auto border border-[#D5DFE4] rounded-[10px] text-[#425A8B] p-5 bg-white">
         <form action="{{route('menu-update')}}" method="post">
            ...
            <div class="w-full flex flex-col">
               ...
               <input type="text" name="title" id="menu_title" class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-[12px] focus:bg-[#f1f1f4]" placeholder="نام منو را وارد کنید" value="{{$menu->title}}" required>
            </div>
            <div class="w-full flex flex-col mt-5">
               <label for="description" class="mb-2">توضیحات آیتم منو:</label>
               <textarea name="description" class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-[12px] focus:bg-[#f1f1f4]" rows="4" id="description" placeholder="توضیحات منو را وارد کنید">{{$menu->description}}</textarea>
            </div>
            <div class="w-full flex flex-col">
               ...
               <input type="text" name="link" id="menu_link" class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-[12px] focus:bg-[#f1f1f4]" placeholder="لینک منو را وارد کنید" value="{{$menu->link}}" required>
            </div>
            <div class="flex flex-col-reverse lg:flex-row gap-5 lg:gap-10 mt-5">
               <div class="xl:w-1/4 flex flex-col">
                  ...
                  <input type="file" name="icon" class="w-full outline-none pr-5 py-3 bg-[#F9F9F9] rounded-[12px] focus:bg-[#f1f1f4]" id="menu_icon" value="{{$menu->icon}}">
               </div>
               <div class="xl:w-1/4 flex flex-col">
                  <label for="menu_image" class="mb-2">تصویر آیتم منو:</label>
                  <input type="file" name="image" class="w-full outline-none pr-5 py-3 bg-[#F9F9F9] rounded-[12px] focus:bg-[#f1f1f4]" id="menu_image" value="{{$menu->image}}">
               </div>
            ...
            <div class="flex flex-col lg:flex-row mt-5 gap-5">
               <div class="w-full lg:w-4/12 flex flex-col gap-3">
                  ...
                  <input type="number" name="priority" id="menu_priority" min="0" class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-[12px] focus:bg-[#f1f1f4]" placeholder="اولویت منو را با اعداد مشخص کنید" value="{{$menu->priority}}" required>
               </div>
