            ...
            <form action="{{ route('settings.colors.upsertColor') }}" method="post">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                    ...
                    <div class="w-full flex flex-row items-center justify-between gap-2">
                        ...
                        <input type="color" value="{{ $settings[0]->meta_value ?? '#FD9636' }}" class="size-10 outline-none"
                            name="--color-primary" id="--color-primary">
                    </div>
                    ...
                    <div class="w-full flex flex-row items-center justify-between gap-2">
                        ...
                        <input type="color" value="{{ $settings[8]->meta_value ?? '#F0F3F8' }}"
                            class="size-10 outline-none" name="--color-primary-btn-hover" id="--color-primary-btn-hover">
                    </div>
                    ...
                    <div class="w-full flex flex-row items-center justify-between gap-2">
                        ...
                        <input type="color" value="{{ $settings[9]->meta_value ?? '#425A8B' }}"
                            class="size-10 outline-none" name="--color-bg-contact-section" id="--color-bg-contact-section">
                    </div>
                    ...
                    <div class="w-full flex flex-row items-center justify-between gap-2">
                        ...
                        <input type="color" value="{{ $settings[11]->meta_value ?? '#334a76' }}"
                            class="size-10 outline-none" name="--color-btn-contact-hover" id="--color-btn-contact-hover">
                    </div>
