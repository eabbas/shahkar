   ...
   @section('title', 'شاهکار | همه متا ها')
   @section('content')
       <div class="w-full flex flex-col pb-4">
           <div class="bg-white rounded-lg">
               <h2 class="text-lg font-bold text-gray-800 p-4 text-center">لیست متا ها</h2>
               <form class="flex flex-col gap-5" action="{{ route('meta_deleteAll') }}" method="post">
                   @csrf
                   ...
                   <div
                       ...
                       <div
                           ...
                           <div
                               ...
                               <span class="block w-32 lg:w-full">عنوان</span>
                           </div>
                           <div
                               class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                               <span class="block w-40 lg:w-full">تاریخ ایجاد</span>
                           </div>
                           <div
                               class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                               ...
                               <div
                                   ...
                                   <div
                                       ...
                                       <div class="w-10 lg:w-full">
                                           <input type="checkbox" class="check" name="metas[]" value="{{ $meta->id }}">
                                       </div>
                                   </div>
                                   <div
                                       class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center">
                                   ...
                                   <div
                                       ...
                                       <span class="block w-32 lg:w-full">{{ $meta->title }}</span>
                                   </div>
                                   <div
                                       class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center col-span-2">
                                       <span class="block w-40 lg:w-full">{{ $meta->created_at }}</span>
                                   </div>
