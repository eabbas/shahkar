...
@section('title', 'شاهکار | لیست سوال ها')
@section('content')
    {{-- <h2>لیست سوال ها</h2>
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-24 lg:w-full truncate">سوال</span>
                        </div>
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100">
                        ...
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100">
                            <span class="block w-24 lg:w-full">فعالیت</span>
                        </div>
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-24 lg:w-full">پاسخ ها</span>
                        </div>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="w-10 lg:w-full">
                                        <input type="checkbox" class="check" name="questions[]"
                                            value="{{ $question->id }}">
                                    </div>
                                </div>
                                <div
                                ...
                                <div
                                    ...
                                    <span class="block w-24 lg:w-full">{{ $question['text'] }}</span>
                                </div>
                                <div
                                    class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center">
                                ...
                                <div class="col-span-2">
                                    <ul class="w-[180px] lg:w-full text-sm mt-1 rounded-sm p-1 grid grid-cols-3">
                                        ...
                                        <li class="flex justify-center">
                                            <a href="{{ route('question-delete',[$question]) }}"
