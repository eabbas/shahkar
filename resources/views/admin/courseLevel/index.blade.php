...
@section('title', 'شاهکار | لیست سطح ها')
@section('content')
    <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">
            <h2 class="text-lg font-bold text-gray-800 p-4 text-center">سطح ها</h2>
                            ...
                            <div class="w-full flex flex-row lg:grid lg:grid-cols-5 items-center divide-x divide-[#f1f1f4]">
                                <div
                                    ...
                                    <div class="w-10 lg:w-full">
                                        <input type="checkbox" class="check" name="levels[]" value="{{ $level->id }}">
                                    </div>
                                </div>
                                <div
                                    class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center">
                                ...
                                <div
                                    class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center">
                                    <span class="block w-20 lg:w-full">{{ $level->title }}</span>
                                </div>

                                <div class="col-span-2">
                                    <ul class="w-[180px] lg:w-full text-sm mt-1 rounded-sm p-1 grid grid-cols-3">
                                        <li class="flex justify-center">
                                            <a href="{{ route('courseLevel.show', [$level]) }}"
                                        ...
                                        <li class="flex justify-center">
                                            <a href="{{ route('courseLevel.edit', [$level]) }}"
                                        ...
                                        <li class="flex justify-center">
                                            <a href="{{ route('courseLevel.delete', [$level]) }}"
