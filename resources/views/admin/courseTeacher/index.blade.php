...
@section('title', 'شاهکار | لیست اساتید')
@section('content')
            ...
            <form class="flex flex-col gap-5" action="{{ route('teacher.deleteAll') }}" method="post">
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-30 lg:w-full">رشته</span>
                        </div>
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="w-10 lg:w-full">
                                        <input type="checkbox" class="check" name="teachers[]" value="{{ $teacher->id }}">
                                    </div>
                                </div>
                                <div
                                    class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center">
                                ...
                                <div class="col-span-3">
                                    ...
                                    <ul class="w-[180px] lg:w-full text-sm mt-1 rounded-sm p-1 col-span-2 grid grid-cols-3">
