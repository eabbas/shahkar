...
@section('title')
    شاهکار | استاد {{ $teacher->name }}
@endsection
@section('content')
    <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">
            <h2 class="text-lg font-bold text-gray-800 p-4 text-center">استاد {{ $teacher->name }}</h2>
            <div class="flex flex-col gap-5">
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-30 lg:w-full">تخصص</span>
                        </div>
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-20 lg:w-full">شماره تلفن</span>
                        </div>
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-20 lg:w-full">شبکه های اجتماعی</span>
                        </div>
                    ...
                    <div class="bg-white divide-y divide-[#f1f1f4]">
                        ...
                        <div class="w-full flex flex-row lg:grid lg:grid-cols-10 items-center divide-x divide-[#f1f1f4]">
                            ...
                            <div
                                ...
                                <span class="block w-30 lg:w-full">{{ $teacher->name }}</span>
                            </div>
                            <div
                                class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center col-span-2">
                                <span class="block w-30 lg:w-full truncate">{{ $teacher->expertise }}</span>
                            </div>
                            <div
                                ...
                                <span class="block w-24 lg:w-full">{{ $teacher->phone }}</span>
                            </div>
                            <div
                                class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 w-[500px] lg:w-full text-center col-span-2">
                            ...
                            <div>
                                ...
                                <ul class="w-[120px] lg:w-full text-sm mt-1 rounded-sm p-1 col-span-2 grid grid-cols-2">
                ...
                <div class="w-11/12 mx-auto">
                    <h2 class="text-lg font-bold mb-4">بیوگرافی</h2>
                    <p class="text-sm font-bold text-justify text-gray-600">
                        {{ $teacher->bio }}
                    </p>
                </div>
            </div>
