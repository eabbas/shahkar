   ...
   @section('title', 'شاهکار | دسته های دوره ها')
   @section('content')
...
">
        ...
        <div class="bg-white rounded-lg">
            ...
            <form class="flex flex-col gap-5" action="{{ route('coursecategory.deleteAll') }}" method="post">
                @csrf
                                ...
                                <div class="col-span-2">
                                    <ul class="w-[180px] lg:w-full text-sm mt-1 rounded-sm p-1 grid grid-cols-3">
                                        <li class="flex justify-center">
                                            <a href="{{ route('coursecategory.adminShow', [$category]) }}"
                                        ...
                                        <li class="flex justify-center">
                                            <a href="{{ route('coursecategory.edit', [$category]) }}"
                                        ...
                                        <li class="flex justify-center">
                                            <a href="{{ route('coursecategory.delete', [$category]) }}"
