    ...
    <div class="2xl:container mx-auto flex flex-row">
        ...
        <div class="hidden lg:block lg:w-3/12 bg-[#0D0E12] fixed right-0 top-0 h-dvh px-5">
            ...
            <div class="py-3 h-[80%] overflow-y-auto flex flex-col gap-3" style="scrollbar-width: none;">
                ...
                <div class="border-b border-gray-500 pb-3">
                    <div class="arrow-down cursor-pointer flex justify-between items-center flex-row-reverse py-1 px-3 rounded-md  @if (Route::is('course.*') || Route::is('coursecategory.*') || Route::is('teacher.*') || Route::is('status.*') || Route::is('courseLevel.*') || Route::is('season.*')) bg-[#383c4d] @endif">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="size-6 fill-white w-[15px] transition-all duration-300  @if (Route::is('course.*') || Route::is('coursecategory.*') || Route::is('teacher.*') || Route::is('status.*') || Route::is('courseLevel.*') || Route::is('season.*')) rotate-180 @endif">
                            <path fill-rule="evenodd"
                                d="M12.53 16.28a.75.75 0 0 1-1.06 0l-7.5-7.5a.75.75 0 0 1 1.06-1.06L12 14.69l6.97-6.97a.75.75 0 1 1 1.06 1.06l-7.5 7.5Z"
                                clip-rule="evenodd" />
                        </svg>
                    ...
                    <div class="overflow-y-auto transition-all duration-300 @if (Route::is('course.*') || Route::is('coursecategory.*') || Route::is('teacher.*') || Route::is('status.*') || Route::is('courseLevel.*') || Route::is('season.*')) max-h-100 @else max-h-0 @endif"
                    style="scrollbar-width: none;">
                        <ul class="gap-2.5 pr-3">
                            <li class="flex flex-row items-center gap-2.5 mt-2.5 mb-2.5 mr-5 text-white">
                                <span class="size-1 bg-white rounded-sm"></span>
