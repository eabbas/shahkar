    ...
    <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">
            ...
            <form class="flex flex-col gap-5" action="{{ route('category.deleteAll') }}" method="post">
                ...
                <div class="w-10/12 mx-auto shadow-md rounded mb-5  [&::-webkit-scrollbar]:hidden lg:overflow-visible">
                    <div class="w-full h-120 max-h-120 overflow-auto ">
                        <div
                            class="w-full flex flex-row lg:grid lg:grid-cols-9 items-center divide-x divide-red-500 sticky top-0 z-2">
                            <div
                                class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100">
                                <p class="block w-20 lg:w-full text-center">ردیف</p>
                            </div>
                            <div
                        ...
                        <div class="bg-white divide-y divide-[#f1f1f4]">
                            ...
                            @foreach ($categories as $category)
                                <div
                                    class="w-full flex flex-row lg:grid lg:grid-cols-9 items-center divide-x divide-red-500 py-4">
                                    <div
