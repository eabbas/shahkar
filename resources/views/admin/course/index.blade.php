...
@section('content')
    ...
    <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">
            ...
            <form class="flex flex-col gap-5" action="{{ route('course.deleteAll') }}" method="post">
                @csrf
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-20 lg:w-full">شرکت کنندگان</span>
                        </div>
                        ...
                        @foreach ($courses as $course)
                            <div
                                ...
                                <div
                                    ...
                                    <span class="block w-20 lg:w-full">{{ $course->title }}</span>
                                </div>
                                <div
                                    class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center col-span-2">
                                ...
                                <div
                                    ...
                                    <span class="block w-24 lg:w-full">{{ count($course->users) }}</span>
                                </div>
                                ...
                                <div class="col-span-3">
                                    <div class="w-[220px] lg:w-full grid grid-cols-3 items-center">
                                        <div
                                            class="p-1 lg:p-3 text-xs text-center lg:text-sm h-full flex items-center justify-center font-medium">
                                            <a href="{{ route('course.users', [$course]) }}" class="text-sky-700">
                                                دانشجویان
                                            </a>
                                        </div>
                                        <ul class="w-full text-sm mt-1 rounded-sm p-1 col-span-2 grid grid-cols-3">
                                            <li class="flex justify-center">
                                                <a href="{{ route('course.adminShow', [$course]) }}"
