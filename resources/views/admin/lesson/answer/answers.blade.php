   ...
   @section('content')
       <h2 style="font-size:24px; margin-bottom:25px; text-align:center;font-weight:bold;color:#222;">
           ...
           <ul style="list-style:none; padding:0; max-width:900px; margin:0 auto;">
               ...
               @foreach ($answers as $answer)
                   @if ($answer->parent_id == 0)
                       <li
                           style="margin-bottom:25px; padding:20px; border:1px solid #e5e7eb; border-radius:12px; background:#ffffff; box-shadow:0 3px 8px rgba(0,0,0,0.05);transition:0.2s;">
                           {{-- متن جواب اصلی --}}
                ...
                ">
                                ...
                                box-shadow:0 4px 15px rgba(0,0,0,0.08); border:1px solid #ddd;">
                                       ...
                                       <div style="margin-bottom:15px;">
                                           ...
                                           <div style="display:flex; gap:25px; align-items:center; flex-wrap:wrap;">
                                               ...
                                               {{-- لایک --}}
                                               <label
                                                   style="display:flex; align-items:center; gap:8px; cursor:pointer; font-size:15px;">
                           ...
                           <div style="display:flex; gap:10px; margin-top:15px;">
                               ...
                               <a href="{{ route('answer_adminReactions', ['courseanswer' => $answer->id]) }}"
                                   style="background:blue; padding:8px 14px; border-radius:6px; text-decoration:none; color:yellow;">
                                   مشاهده ریکشن ها
                               </a>
       ...
       <div
           style="max-width:900px;margin:40px auto;padding:20px;background:#ffffff;border-radius:12px;border:1px solid #e5e7eb;box-shadow:0 3px 8px rgba(0,0,0,0.05);">
