...
@section('title', 'شاهکار | لیست عنوان ارور ها')
@section('content')
    ...
    <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">
            <div class="flex flex-row justify-between items-end my-4">
                <div>
                    <h1 class="text-sm lg:text-lg font-bold">عنوان خطا ها</h1>
                </div>
                <div>
                    <a href="{{ route('errortitle_create') }}"
                        class="text-xs px-2 py-0.5 rounded-sm bg-gray-800 text-white">ایجاد عنوان جدید</a>
                </div>
            </div>
            <form class="flex flex-col gap-5" action="{{ route('courseLevel.deleteAll') }}" method="post">
                @csrf
                ...
                <div
                    class="w-11/12 lg:w-3/4 mx-auto shadow-md rounded mb-5 overflow-x-auto [&::-webkit-scrollbar]:hidden lg:overflow-visible">
                    <div
                            ...
                            <div class="w-full flex flex-row lg:grid lg:grid-cols-5 items-center divide-x divide-[#f1f1f4]">
                                <div
                                    ...
                                    <div class="w-10 lg:w-full">
                                        <input type="checkbox" class="check" name="errors[]" value="{{ $item->id }}">
                                    </div>
                                </div>
                                <div
                                    class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center">
                                ...
                                <div class="col-span-2">
                                    <ul class="w-[180px] lg:w-full text-sm mt-1 rounded-sm p-1 grid grid-cols-2">
