<style>
    ...
    .action-blue { background:#e8f0ff; color:#0056d2; }
    .action-red { background:#ffe8e8; color:#d40000; }
    .action-gray { background:#f2f2f2; color:#555; }
    .action-green { background:#e7ffe8; color:#0f8b26; }
    .action-brown { background:#f5e7da; color:#8b4513; }
    .action-teal { background:#e3fffd; color:#00796b; }
