...
<body>
   <div class="w-full h-svh bg-[url('https://keenthemes.com/static/metronic/tailwind/dist/assets/media/images/2600x1200/bg-10.png')] bg-cover bg-no-repeat">
      <h2 class="text-3xl text-center font-bold py-5 text-[#425A8B]">فرم ایجاد سوال</h2>
      <div class="w-2/3 mx-auto border border-[#D5DFE4] rounded-[10px] text-[#425A8B] p-5 bg-white">
         <form action="{{route('question-store')}}" method="post">
            @csrf
            <div class="w-full flex flex-col mt-5">
               <label for="question" class="mb-2 flex flex-row items-center">
                  <span> پرسش خود را ثبت کنید:</span>
                  <span class="text-rose-500">*</span>
               </label>
               <textarea name="question_text" class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-[12px] focus:bg-[#f1f1f4]" rows="4" id="question" placeholder="پرسش خود را وارد کنید."></textarea>
            </div>
